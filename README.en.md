...
- [WondrousBox/Chobits](https://github.com/WondrousBox/Chobits) —— the predecessor of this project; the desktop-pet foundation and core interaction evolved from it.
- [Open-LLM-VTuber](https://github.com/Open-LLM-VTuber/Open-LLM-VTuber) —— the source of the Live2D avatar approach, and a key reference for the voice interaction pipeline (ASR → LLM → TTS) and sherpa-onnx model selection.
