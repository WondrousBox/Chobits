...
export type PluginResourceIpcType = {
  ...
  'plugin-resource:setDownloadDir': (payload: { dir: string }) => Promise<{ ok: boolean; error?: string }>;
  'plugin-resource:getPluginsDir': () => Promise<{ ok: boolean; path?: string }>;
  'plugin-resource:setPluginsDir': (payload: { dir: string }) => Promise<{ ok: boolean; error?: string }>;
