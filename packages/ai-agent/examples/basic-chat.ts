...
import { CalculatorTool, ConsoleLogger, DefaultAgentRuntime, GetTimeTool, LogLevel, OpenAIAdapter, RegistryToolProvider } from '../src';
...
async function main() {
    ...
    logger.info(`Registered ${tools.size} tools: ${tools.names().join(', ')}`);
