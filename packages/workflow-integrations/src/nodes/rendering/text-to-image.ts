...
import { WORKFLOW_RENDERING } from '../../capabilities/rendering';
...
export const TextToImageNode: NodeHandler = {
  ...
  requiredCapabilities: [WORKFLOW_RENDERING],
  ...
  async run({ input, config, ctx, emit, capabilities }) {
    ...
    const renderHtmlScreenshot = capabilities.require(WORKFLOW_RENDERING).renderHtmlScreenshot;
