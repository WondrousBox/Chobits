...
const TOOLBOX_SOURCE_PATH = TOOLBOX_SOURCE_URL.protocol === 'file:' ? fileURLToPath(TOOLBOX_SOURCE_URL) : path.resolve(process.cwd(), 'packages/ai/runtime/pi/toolbox.md');
