 ...
 *
 * 设计：toolbox.md 作为编辑源文件，内容通过 TOOLBOX_CONTENT 常量嵌入。
 * 编辑 toolbox.md 后需同步更新此处的 TOOLBOX_CONTENT。
 * 未来可替换为 Vite raw import: import content from './toolbox.md?raw'
 */
...
// ━━ Embedded Content (source: toolbox.md) ━━
