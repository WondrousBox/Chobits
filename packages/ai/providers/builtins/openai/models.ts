...
export const openaiChatModels: ChatProviderModelCard[] = [
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'GPT-5.2 pro: a smarter, more precise GPT-5.2 variant (Responses API only), suited for hard problems and longer multi-turn reasoning.',
  ...
  },
  {
    ...
    description: 'GPT-5.2 Chat is the ChatGPT variant (chat-latest) for the latest conversation improvements.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'GPT-5.1 — a flagship model optimized for coding and agent tasks with configurable reasoning effort and longer context.',
    displayName: 'GPT-5.1',
    id: 'gpt-5.1',
    maxOutput: 128_000,
    pricing: {
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'GPT-5.1 Codex: a GPT-5.1 variant optimized for agentic coding tasks, for complex code/agent workflows in the Responses API.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'GPT-5.1 Codex mini: a smaller, lower-cost Codex variant optimized for agentic coding tasks.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'GPT-5 Codex is a GPT-5 variant optimized for agentic coding tasks in Codex-like environments.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'The best model for cross-domain coding and agent tasks. GPT-5 leaps in accuracy, speed, reasoning, context awareness, structured thinking, and problem solving.',
    displayName: 'GPT-5',
    id: 'gpt-5',
    maxOutput: 128_000,
    pricing: {
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'A faster, more cost-efficient GPT-5 variant for well-defined tasks, delivering quicker responses while maintaining quality.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'The fastest and most cost-effective GPT-5 variant, ideal for latency- and cost-sensitive applications.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'The GPT-5 model used in ChatGPT, combining strong understanding and generation for conversational applications.',
  ...
  },
  {
    ...
    description: 'o4-mini is the latest small o-series model, optimized for fast, effective reasoning with high efficiency in coding and vision tasks.',
    displayName: 'o4-mini',
    id: 'o4-mini',
    maxOutput: 100_000,
    pricing: {
  ...
  },
  {
    ...
    contextWindowTokens: 200_000,
    description: 'o4-mini-deep-research is a faster, more affordable deep research model for complex multi-step research. It can search the web and also access your data via MCP connectors.',
  ...
  },
  {
    ...
    contextWindowTokens: 200_000,
    description: 'o3-pro uses more compute to think deeper and consistently deliver better answers; available only via the Responses API.',
    displayName: 'o3-pro',
    id: 'o3-pro',
    maxOutput: 100_000,
    pricing: {
  ...
  },
  {
    ...
    contextWindowTokens: 200_000,
    description: 'o3-deep-research is our most advanced deep research model for complex multi-step tasks. It can search the web and access your data via MCP connectors.',
  ...
  },
  {
    ...
    contextWindowTokens: 200_000,
    description: 'o3-mini is our latest small reasoning model, delivering higher intelligence at the same cost and latency targets as o1-mini.',
    displayName: 'o3-mini',
    id: 'o3-mini',
    maxOutput: 100_000,
    pricing: {
  ...
  },
  {
    ...
    contextWindowTokens: 1_047_576,
    description: 'GPT-4.1 mini balances intelligence, speed, and cost, making it attractive for many use cases.',
  ...
  },
  {
    ...
    contextWindowTokens: 128_000,
    description: 'GPT-4o mini Search Preview is trained to understand and execute web search queries via the Chat Completions API. Web search is billed per tool call in addition to token costs.',
  ...
  },
  {
    ...
    contextWindowTokens: 128_000,
    description: 'ChatGPT-4o is a dynamic model updated in real time, combining strong understanding and generation for large-scale use cases like customer support, education, and technical support.',
    displayName: 'GPT-4o',
    id: 'gpt-4o',
    pricing: {
      units: [
  ...
  },
  {
    ...
    contextWindowTokens: 128_000,
    description: 'GPT-4o Search Preview is trained to understand and execute web search queries via the Chat Completions API. Web search is billed per tool call in addition to token costs.',
  ...
  },
  {
    ...
    contextWindowTokens: 128_000,
    description: 'GPT Audio is a general chat model for audio input/output, supported in the Chat Completions API.',
  ...
  },
  {
    ...
    description: 'GPT 3.5 Turbo for text generation and understanding tasks, optimized for instruction following.',
  ...
  },
  {
    ...
    contextWindowTokens: 200_000,
    description: 'codex-mini-latest is a fine-tuned o4-mini model for the Codex CLI. For direct API use, we recommend starting with gpt-4.1.',
  ...
  },
  {
    ...
    contextWindowTokens: 8192,
    description: 'computer-use-preview is a specialized model for the "computer use tool," trained to understand and execute computer-related tasks.',
...
export const openaiEmbeddingModels: EmbeddingProviderModelCard[] = [
  ...
  {
    contextWindowTokens: 8192,
    description: 'An efficient, cost-effective next-generation embedding model for retrieval and RAG scenarios.',
...
export const openaiTTSModels: TTSProviderModelCard[] = [
  ...
  {
    description: 'GPT-4o mini TTS is a text-to-speech model built on GPT-4o mini, converting text into natural-sounding speech with a max input of 2000 tokens.',
...
export const openaiSTTModels: STTProviderModelCard[] = [
  {
    description: 'A general speech recognition model supporting multilingual ASR, speech translation, and language identification.',
    displayName: 'Whisper',
    id: 'whisper-1',
    pricing: {
      units: [
  ...
  },
  {
    ...
    description: 'GPT-4o Transcribe is a speech-to-text model that transcribes audio with GPT-4o, improving word error rate, language ID, and accuracy over the original Whisper model.',
  ...
  {
    contextWindowTokens: 16_000,
    description: 'GPT-4o Mini Transcribe is a speech-to-text model that transcribes audio with GPT-4o, improving word error rate, language ID, and accuracy over the original Whisper model.',
...
export const openaiImageModels: ImageProviderModelCard[] = [
  {
    description: 'An enhanced GPT Image 1 model with 4× faster generation, more precise editing, and improved text rendering.',
  ...
  {
    description: 'A lower-cost GPT Image 1 variant with native text and image input and image output.',
  ...
  {
    description: 'Second-generation DALL·E model with more realistic, accurate image generation and 4× the resolution of the first generation.',
...
export const openaiRealtimeModels: RealtimeProviderModelCard[] = [
  {
    ...
    description: 'A general real-time model supporting real-time text and audio I/O, plus image input.',
