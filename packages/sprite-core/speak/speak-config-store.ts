...
function normalizeAiProviderConfig(raw: unknown): SpriteSpeakAIProviderConfig {
  ...
  return {
    ...
    speechLanguage: source.speechLanguage === 'zh' || source.speechLanguage === 'ja' || source.speechLanguage === 'en' ? source.speechLanguage : DEFAULT_AI_PROVIDER_SPEAK_CONFIG.speechLanguage,
    audioSetting: {
