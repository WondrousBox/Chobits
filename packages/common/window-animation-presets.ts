import type { WindowAnimationAnchor, WindowAnimationBounds, WindowAnimationKeyframe, WindowAnimationPlacement, WindowAnimationTimeline } from '@packages/common/types/window-animation';
