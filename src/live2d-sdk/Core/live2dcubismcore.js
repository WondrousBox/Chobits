            ...
            : t
              ? ('undefined' != typeof read &&
                ...
                'undefined' != typeof print &&
                  (((console = 'undefined' == typeof console ? {} : console).log = print), (console.warn = console.error = 'undefined' != typeof printErr ? printErr : print)))
              : (p || q) &&
      ...
      function da() {
        return {
          exports: (function (asmLibraryArg, wasmMemory, wasmTable) {
            ...
            return (
                                  ...
                                  : Xn >= x(1)
                                    ...
                                    : Vn <= x(0)
                                      ? ((Un = x(x(Vn + x(2)) * x(0.5))),
                                        ...
                                        (no = x(x(x(Vn * $n) + _n) - Qn)),
                                        (io = u[((Pn = (Wn + (Pn << 3)) | 0) + 4) >> 2]),
                                        (jo = u[Pn >> 2]),
                                        (go = u[((Pn = (Wn + (Sn << 3)) | 0) + 4) >> 2]),
                                        (ho = u[Pn >> 2]))
                                      : Pn
                                        ? ((ao = Rn = x(bo * x(3))),
                                          (Pn = Ln),
                                          ...
                                          (Un = x(x(Vn + x(-1)) * x(0.5))),
                                          (Tn = x(Qn - Tn)),
                                          (eo = u[((Pn = (Wn + ((Pn + to) << 3)) | 0) + 4) >> 2]),
                                          (fo = u[Pn >> 2]),
                                          (mo = u[((Pn = (Wn + ((Sn + to) << 3)) | 0) + 4) >> 2]),
                                          (no = u[Pn >> 2]))
                ...
                var Dn,
                  ...
                  Bn = (function (a) {
                    ...
                    a: if ((El = 2147483647 & (Gl = b[0])) >>> 0 <= 1061752794) ((Dl = x(1)), El >>> 0 < 964689920 || (Dl = ba(+a)));
                      ...
                      ((Hl = +a),
                        (Dl = 1075235812 <= El >>> 0 ? x(-ba(((0 | Gl) < 0 ? 3.141592653589793 : -3.141592653589793) + Hl)) : aa((0 | Gl) <= -1 ? 1.5707963267948966 + Hl : 1.5707963267948966 - Hl)));
                  ...
                  An = (function (a) {
                    ...
                    a: if ((Vk = 2147483647 & (Cl = b[0])) >>> 0 <= 1061752794) Vk >>> 0 < 964689920 || (a = aa(+a));
                      ...
                      ((Bl = +a),
                        (a =
                          Vk >>> 0 <= 1085271519 ? ((0 | Cl) <= -1 ? ba(Bl + 4.71238898038469) : x(-ba(Bl + -4.71238898038469))) : aa(((0 | Cl) < 0 ? 6.283185307179586 : -6.283185307179586) + Bl)));
              ...
              (n[4] = function (a, mh) {
                ...
                if (
                  ...
                  ((oh = q[(qh + 16) >> 2] << 2),
                    ...
                    (q[(28 + nh) >> 2] = oh),
                    (q[(16 + nh) >> 2] = 0),
                    (zh = 1 == q[((th = (ph + (sh << 5)) | 0) + 12) >> 2] ? x(-10) : x(-0.10000000149011612)),
                    (u[(20 + nh) >> 2] = zh),
                    (q[(60 + nh) >> 2] = oh),
                    (q[(56 + nh) >> 2] = xh),
                  ...
                  ((rh = (function (a, ji) {
                    var ki = x(0);
                    if ((ki = x(Ba(u[(a + 4) >> 2], u[a >> 2]) - Ba(u[(ji + 4) >> 2], u[ji >> 2]))) < x(-3.1415927410125732))
                      for (;;) if (!((ki = x(ki + x(6.2831854820251465))) < x(-3.1415927410125732))) break;
                    if (ki > x(3.1415927410125732)) for (;;) if (!((ki = x(ki + x(-6.2831854820251465))) > x(3.1415927410125732))) break;
                    return ki;
                  })((16 + nh) | 0, (8 + nh) | 0)),
              ...
              (n[6] = function (a, vj, xj, yj) {
                ...
                var Vj = 0,
                  ...
                  ak = 0;
                if (1 <= (0 | (Yj = q[(a + 8) >> 2])))
                  for (_j = q[(a + 12) >> 2], Zj = q[(a + 20) >> 2]; ;) if (((u[((Wj = Vj << 2) + _j) >> 2] = u[(vj + Wj) >> 2] * u[(Wj + Zj) >> 2]), !((0 | (Vj = (Vj + 1) | 0)) < (0 | Yj)))) break;
                if (!((0 | (Yj = q[a >> 2])) < 1))
                  if (((_j = q[(a + 4) >> 2]), yj))
                    for (Wj = vj = 0; ;) {
                      if (q[yj >> 2]) {
                        if ((0 | (Vj = q[((Zj = vj << 2) + q[(a + 16) >> 2]) >> 2])) < 1) Xj = x(0);
                        else for ($j = (Vj + Wj) | 0, ak = q[(a + 12) >> 2], Xj = x(0), Vj = Wj; ;) if (((Xj = x(Xj + u[(ak + (Vj << 2)) >> 2])), !((0 | (Vj = (Vj + 1) | 0)) < (0 | $j)))) break;
                        u[(xj + Zj) >> 2] = Xj;
                      }
                    ...
                    for (Zj = q[(a + 16) >> 2], vj = yj = 0; ;) {
                      ...
                      else for ($j = (vj + Vj) | 0, ak = q[(a + 12) >> 2], Xj = x(0), Vj = vj; ;) if (((Xj = x(Xj + u[(ak + (Vj << 2)) >> 2])), !((0 | (Vj = (Vj + 1) | 0)) < (0 | $j)))) break;
              ...
              (n[7] = function (a, vj, xj, yj) {
                ...
                var zj = 0,
                  ...
                  Uj = 0;
                if (1 <= (0 | (Tj = q[(a + 8) >> 2])))
                  for (Rj = q[(a + 12) >> 2], Sj = q[(a + 20) >> 2]; ;) if (((u[((Qj = zj << 2) + Rj) >> 2] = u[(vj + Qj) >> 2] * u[(Qj + Sj) >> 2]), !((0 | (zj = (zj + 1) | 0)) < (0 | Tj)))) break;
                if (!((0 | (zj = q[a >> 2])) < 1))
                  if (((Tj = q[(a + 4) >> 2]), yj))
                    for (Qj = vj = 0; ;) {
                      if (q[yj >> 2]) {
                        if ((0 | (zj = q[((Rj = vj << 2) + q[(a + 16) >> 2]) >> 2])) < 1) Aj = x(0);
                        else for (Sj = (zj + Qj) | 0, Uj = q[(a + 12) >> 2], Aj = x(0), zj = Qj; ;) if (((Aj = x(Aj + u[(Uj + (zj << 2)) >> 2])), !((0 | (zj = (zj + 1) | 0)) < (0 | Sj)))) break;
                    ...
                    for (Rj = q[(a + 16) >> 2], vj = yj = 0; ;) {
                      ...
                      else for (Sj = (vj + zj) | 0, Uj = q[(a + 12) >> 2], Aj = x(0), zj = vj; ;) if (((Aj = x(Aj + u[(Uj + (zj << 2)) >> 2])), !((0 | (zj = (zj + 1) | 0)) < (0 | Sj)))) break;
                      if (
                        ((zj = (xj + Qj) | 0),
                    ...
                    for (;;) {
                      if (
                        ...
                        for (Kj = (Dj + Gj) | 0, Lj = q[(a + 20) >> 2], Bj = Gj; ;) {
                          for (Mj = u[((Cj = Bj << 2) + Lj) >> 2], Nj = q[(vj + Cj) >> 2], Fj = 0; ;)
                            if (((u[(Cj = ((Dj = Fj << 2) + Hj) | 0) >> 2] = u[Cj >> 2] + x(Mj * u[(Dj + Nj) >> 2])), (0 | Ij) == (0 | (Fj = (Fj + 1) | 0)))) break;
                ...
                if (!(q[(a + 648) >> 2] || (0 | (Ie = q[(a + 332) >> 2])) < 1))
                  for (Ne = ((Je = q[(a + 336) >> 2]) + w(Ie, 20)) | 0, Ie = q[(a + 424) >> 2], Le = q[(a + 444) >> 2]; ;) {
                    if (q[Ie >> 2] && !((0 | (Ke = q[(Je + 16) >> 2])) < (a = 1)))
                      for (Ke <<= 1, Oe = q[Le >> 2]; ;) if (((u[(Me = ((a << 2) + Oe) | 0) >> 2] = -u[Me >> 2]), !((0 | (a = (a + 2) | 0)) < (0 | Ke)))) break;
                    if (((Le = (Le + 4) | 0), (Ie = (Ie + 4) | 0), !((Je = (Je + 20) | 0) >>> 0 < Ne >>> 0))) break;
                  }
              }),
              (n[10] = function (a, Sm, un) {
                var wn;
                return ($((wn = q[((a |= 0) + 20) >> 2]), (Sm |= 0), (Sm = (un |= 0) >>> 0 < (Sm = (q[(a + 16) >> 2] - wn) | 0) >>> 0 ? un : Sm)), (q[(a + 20) >> 2] = Sm + q[(a + 20) >> 2]), 0 | un);
              }),
              (n[11] = function (a, Il, Rm, Sm, Tm, Um) {
                ...
                if (
                  ...
                  (kn = (0 | Vm) < -1 || ((0 | Vm) <= -1 ? qn : 0) ? (h(+(Il = -Il)), (Vm = 0 | b[1]), b[0], (jn = 1), 3840) : 2048 & Tm ? ((jn = 1), 3843) : (jn = 1 & Tm) ? 3846 : 3841),
                  ...
                  (_(
                    ...
                    32,
                    Rm,
                    ($m = ((Um = !Sm | ((0 | Sm) <= ((((Wm - Zm) | 0) - 18) | 0)) ? (((((fn - ((16 + Zm) | 0)) | 0) - cn) | 0) + Wm) | 0 : (2 + ((((Sm + fn) | 0) - cn) | 0)) | 0) + _m) | 0),
                    Tm
                  ),
                    Z(a, en, _m),
                  ...
                  for (
                    ...
                    if (((Xm = ((Sm = Xm) + 4) | 0), 0 == (Il = 1e9 * (Il - ((q[Sm >> 2] = Vm = (Il < 4294967296) & (0 <= Il) ? ~~Il >>> 0 : 0) >>> 0))))) break;
                  if ((0 | Ym) < 1) ((Vm = Xm), (Wm = dn));
                    ...
                    for (Wm = dn; ;) {
                      ...
                      for (;;) if (!(Wm >>> 0 < (Vm = Xm) >>> 0) || q[(Xm = (Vm + -4) | 0) >> 2]) break;
                  ...
                  if ((0 | Ym) <= -1)
                    for (hn = (1 + ((((an + 25) | 0) / 9) | 0)) | 0, cn = 102 == (0 | qn); ;) {
                      if (((bn = (0 | Ym) < -9 ? 9 : (0 - Ym) | 0), Vm >>> 0 <= Wm >>> 0)) Wm = q[Wm >> 2] ? Wm : (Wm + 4) | 0;
                        ...
                        for (en = 1e9 >>> bn, _m = (-1 << bn) ^ -1, Ym = 0, Xm = Wm; ;)
                          if (((Sm = q[Xm >> 2]), (q[Xm >> 2] = (Sm >>> bn) + Ym), (Ym = w(en, Sm & _m)), !((Xm = (Xm + 4) | 0) >>> 0 < Vm >>> 0))) break;
                  ...
                  if (!(Vm >>> (Xm = 0) <= Wm >>> 0 || ((Xm = w((dn - Wm) >> 2, 9)), (Sm = q[Wm >> 2]) >>> 0 < (Ym = 10))))
                    for (;;) if (((Xm = (Xm + 1) | 0), !((Ym = w(Ym, 10)) >>> 0 <= Sm >>> 0))) break;
                  if ((0 | (Sm = (((an - (102 == (0 | qn) ? 0 : Xm)) | 0) - ((103 == (0 | qn)) & (0 != (0 | an)))) | 0)) < ((w((Vm - dn) >> 2, 9) + -9) | 0)) {
                    if ((($m = (((dn + ((Sm = ((0 | (_m = (Sm + 9216) | 0)) / 9) | 0) << 2)) | 0) - 4092) | 0), (Ym = 10), (0 | (Sm = (1 + ((_m - w(Sm, 9)) | 0)) | 0)) <= 8))
                      for (;;) if (((Ym = w(Ym, 10)), 9 == (0 | (Sm = (Sm + 1) | 0)))) break;
                    if (
                      ((hn = ($m + 4) | 0),
                      ...
                      if (1e9 <= (q[$m >> 2] = Sm = (Sm + Ym) | 0) >>> 0)
                        for (;;)
                          if ((($m = ($m + -4) | (q[$m >> 2] = 0)) >>> 0 < Wm >>> 0 && (q[(Wm = (Wm + -4) | 0) >> 2] = 0), (Sm = (q[$m >> 2] + 1) | 0), !(999999999 < (q[$m >> 2] = Sm) >>> 0))) break;
                      if (((Xm = w((dn - Wm) >> 2, 9)), !((Sm = q[Wm >> 2]) >>> 0 < (Ym = 10)))) for (;;) if (((Xm = (Xm + 1) | 0), !((Ym = w(Ym, 10)) >>> 0 <= Sm >>> 0))) break;
                    }
                  ...
                  if (103 != (0 | qn)) _m = 8 & Tm;
                    ...
                    if (((Vm = 9), en && (_m = q[(cn + -4) >> 2]) && !((_m >>> (Vm = 0)) % (Sm = 10)))) for (;;) if (((Vm = (Vm + 1) | 0), (_m >>> 0) % ((Sm = w(Sm, 10)) >>> 0))) break;
                    ((Sm = (w((cn - dn) >> 2, 9) + -9) | 0),
                      (an =
                        102 == (32 | Um)
                  ...
                  if ((($m = 0 != (0 | (Ym = an | _m))), (Sm = a), (mn = Rm), (Vm = 0 < (0 | Xm) ? Xm : 0), 102 != (0 | (bn = 32 | Um)))) {
                    if (((fn - (Vm = ga(((Vm = Xm >> 31) + Xm) ^ Vm, 0, fn))) | 0) <= 1) for (;;) if (((o[0 | (Vm = (Vm + -1) | 0)] = 48), !(((fn - Vm) | 0) < 2))) break;
                  ...
                  if ((_(Sm, 32, mn, ($m = (1 + ((Vm + (($m + ((an + jn) | 0)) | 0)) | 0)) | 0), Tm), Z(a, kn, jn), _(a, 48, Rm, $m, 65536 ^ Tm), 102 == (0 | bn))) {
                    for (Sm = (16 + Zm) | 8, Xm = (16 + Zm) | 9, Wm = Um = dn >>> 0 < Wm >>> 0 ? dn : Wm; ;) {
                      if (((Vm = ga(q[Wm >> 2], 0, Xm)), (0 | Um) != (0 | Wm))) {
                        if (!(Vm >>> 0 <= (16 + Zm) >>> 0)) for (;;) if (((o[0 | (Vm = (Vm + -1) | 0)] = 48), !((16 + Zm) >>> 0 < Vm >>> 0))) break;
                    ...
                    p: if (!(((0 | an) < 1) | (cn >>> 0 <= Wm >>> 0)))
                      for (;;) {
                        if ((16 + Zm) >>> 0 < (Vm = ga(q[Wm >> 2], 0, Xm)) >>> 0) for (;;) if (((o[0 | (Vm = (Vm + -1) | 0)] = 48), !((16 + Zm) >>> 0 < Vm >>> 0))) break;
              ...
              (n[12] = function (a, Il) {
                ...
                var tm = 0,
                  tm = (Il |= 0);
                ((Il = (q[Il >> 2] + 15) & -16), (q[tm >> 2] = Il + 16), (tm = a), (a = Cc(q[Il >> 2], q[(Il + 4) >> 2], q[(Il + 8) >> 2], q[(Il + 12) >> 2])), (v[tm >> 3] = a));
              }),
              (n[13] = function (a) {
                return 0;
              }),
              (n[14] = function (a, Il, tm) {
                ...
                for (
                  ...
                  a: {
                    if (
                      ((Lm = (Bm = 0) | K(q[(a + 60) >> 2], 0 | Il, 0 | Nm, (12 + Cm) | 0)) && ((q[2086] = Lm), (Bm = -1)), (0 | (Bm = Bm ? (q[(12 + Cm) >> 2] = -1) : q[(12 + Cm) >> 2])) == (0 | Mm))
                    )
                      ((Il = q[(a + 44) >> 2]), (q[(a + 28) >> 2] = Il), (q[(a + 20) >> 2] = Il), (q[(a + 16) >> 2] = Il + q[(a + 48) >> 2]), (a = tm));
                    else {
                      if (-1 < (0 | Bm)) break a;
              ...
              }),
              {
                ...
                g: function (a, vj) {
                  return (
                    (vj |= 0),
                    (L = vj = (L - 16) | 0),
                    (a = (a |= 0) ? (sa(a) ? (Y(4, 2150, 0), 0) : r[(a + 4) | 0]) : ((q[(vj + 4) >> 2] = 1444), (q[vj >> 2] = 2267), Y(4, 1294, vj), 0)),
                    (L = (vj + 16) | 0),
                    0 | a
                  );
                },
                                ...
                                if (!(6 <= Xk >>> 0)) {
                                  ...
                                  f: {
                                    ...
                                    if ((a = 0) < (0 | (Xk = q[(Vk + 4) >> 2]))) {
                                      ...
                                      if (((Zk = q[(Vk + 48) >> 2]), ($k = (Zk + -1) | 0), !(((Xk = 0) | (a = q[(Vk + 4) >> 2])) <= 0))) {
                                        for (Yk = q[(_k + 112) >> 2]; ;) {
                                          if (((0 | (al = q[(Yk + (Xk << 2)) >> 2])) < 0) | ((0 | Zk) <= (0 | al))) break f;
                                          if ((0 | a) == (0 | (Xk = (Xk + 1) | 0))) break;
                                        }
                                    ...
                                    if (((Xk = 0), (Yk = q[(Vk + 40) >> 2]), 0 < (0 | ($k = q[(Vk + 8) >> 2]))))
                        ...
                        : ((ej + 63) & -64) == (0 | ej) && ej
                          ? (function (a) {
                              ...
                              ((q[(24 + (L = Qk = (L - 32) | 0)) >> 2] = 0),
                                ...
                                (function (a) {
                                  var Uh;
                                  (Ka((16 + (L = Uh = (L - 272) | 0)) | 0, 2227, (q[(12 + Uh) >> 2] = a)), Sa((16 + Uh) | 0), (L = (272 + Uh) | 0));
                                })((16 + Qk) | 0));
                              a: {
                                if (sa(a)) Y(4, 1932, 0);
                                else {
                                  if (!(6 <= (Mk = r[(a + 4) | 0]) >>> 0)) {
                                    if (
                                      (1 != (0 | !r[(a + 5) | 0]) ? (da((a + 4) | 0, 1), X((a - -64) | 0, 4, 160), (o[(a + 5) | 0] = 0), na(a, (a + 704) | 0), ya(a)) : na(a, (a + 704) | 0),
                                      r[7224] || ((q[1807] = 6), (o[7224] = 1), (q[1808] = 7), (q[1809] = 8), (q[1810] = 9)),
                                      (Lk = q[(a + 704) >> 2]),
                                      1 <= (0 | (Mk = q[(Lk + 16) >> 2])))
                                    ) {
                                      for (Nk = q[(a + 912) >> 2], Sk = (Nk + (Mk << 2)) | 0, Ok = q[(a + 908) >> 2]; ;) {
                                        ((Rk = (q[(a + 1204) >> 2] + (q[Ok >> 2] << 2)) | 0), (Lk = 0), (Mk = q[Nk >> 2]), (Kk = (Mk + -1) | 0));
                                        d: if (!((0 | Kk) < 1))
                                          e: for (;;) {
                                            for (;;) {
                                                    ...
                                                    a: if ((0 | a) != (0 | Vk)) {
                                                      ...
                                                      if (((rl = 3 & (a ^ Vk)), a >>> 0 < Vk >>> 0)) {
                                                        if (!rl) {
                                                          ...
                                                          if (!(ql >>> 0 <= 3)) {
                                                            for (rl = ql; ;) if (((q[a >> 2] = q[Vk >> 2]), (Vk = (Vk + 4) | 0), (a = (a + 4) | 0), !(3 < (rl = (rl + -4) | 0) >>> 0))) break;
                                                            ql &= 3;
                                                          }
                                                        }
                                                        if (ql) for (;;) if (((o[0 | a] = r[0 | Vk]), (a = (a + 1) | 0), (Vk = (Vk + 1) | 0), !(ql = (ql + -1) | 0))) break;
                                                      } else {
                                                        if (!rl) {
                                                          if (3 & sl)
                                                            for (;;) {
                                                          ...
                                                          if (!(ql >>> 0 <= 3)) for (;;) if (((q[((ql = (ql + -4) | 0) + a) >> 2] = q[(Vk + ql) >> 2]), !(3 < ql >>> 0))) break;
                                                        }
                                                        if (ql) for (;;) if (((o[((ql = (ql + -1) | 0) + a) | 0] = r[(Vk + ql) | 0]), !ql)) break;
                                                      }
                                                    }
                                                  })(Pk, (Pk + 4) | 0, ((-1 ^ Lk) + Mk) << 2),
                                                  (0 | Lk) < (0 | (Kk = ((Mk = Kk) + -1) | 0)))
                                    ...
                                    if (1 <= q[Lk >> 2])
                                      for (Kk = 0; ;)
                                        if (((q[(q[(a + 712) >> 2] + (Kk << 2)) >> 2] = q[(a + 716) >> 2] + (Kk << 6)), (Kk = (Kk + 1) | 0), (Lk = q[(a + 704) >> 2]), !((0 | Kk) < q[Lk >> 2]))) break;
                                    if (1 <= q[(Lk + 4) >> 2])
                                      for (Kk = 0; ;)
                                        if (((q[(q[(a + 744) >> 2] + (Kk << 2)) >> 2] = q[(a + 748) >> 2] + (Kk << 6)), (Kk = (Kk + 1) | 0), (Lk = q[(a + 704) >> 2]), !((0 | Kk) < q[(Lk + 4) >> 2])))
                                          break;
                                    if (1 <= q[(Lk + 16) >> 2])
                                      for (Kk = 0; ;)
                                        if (
                                    ...
                                    if (1 <= q[(Lk + 20) >> 2])
                                      for (Kk = 0; ;)
                                        if (((q[(q[(a + 916) >> 2] + (Kk << 2)) >> 2] = q[(a + 920) >> 2] + (Kk << 6)), (Kk = (Kk + 1) | 0), (Lk = q[(a + 704) >> 2]), !((0 | Kk) < q[(Lk + 20) >> 2])))
                                          break;
                                    if (1 <= q[(Lk + 80) >> 2])
                                      for (Kk = 0; ;)
                                        if (
                                          ((q[(q[(a + 1240) >> 2] + (Kk << 2)) >> 2] = q[(a + 1244) >> 2] + (Kk << 6)), (Kk = (Kk + 1) | 0), (Lk = q[(a + 704) >> 2]), !((0 | Kk) < q[(Lk + 80) >> 2]))
                                        )
                                          break;
                                    ...
                                    for (Kk = q[(a + 904) >> 2], Rk = q[(a + 900) >> 2], Pk = q[(a + 1200) >> 2], Ok = 0; ;) {
                                      if (0 < (0 | (Sk = (q[((Mk = Ok << 2) + Kk) >> 2] + -1) | 0)))
                                        for (Tk = (Pk + (q[(Mk + Rk) >> 2] << 1)) | 0, Lk = 0; ;)
                                          if (((Uk = s[(Mk = (Tk + (Lk << 1)) | 0) >> 1]), (p[Mk >> 1] = s[(Mk + 4) >> 1]), (p[(Mk + 4) >> 1] = Uk), !((0 | (Lk = (Lk + 3) | 0)) < (0 | Sk)))) break;
                                      if ((0 | Nk) == (0 | (Ok = (Ok + 1) | 0))) break;
                                    }
                                    for (Mk = q[(a + 892) >> 2], Ok = q[(a + 896) >> 2], Rk = q[(a + 1196) >> 2], Kk = 0; ;) {
                                      if (1 <= (0 | (Pk = q[((Lk = Kk << 2) + Mk) >> 2])))
                                        for (Lk = (Rk + (q[(Lk + Ok) >> 2] << 2)) | 0, Pk = (Lk + (Pk << 3)) | 0, Lk = (Lk + 4) | 0; ;)
                                          if (((u[Lk >> 2] = x(1) - u[Lk >> 2]), !((Lk = (Lk + 8) | 0) >>> 0 < Pk >>> 0))) break;
                ...
                V: function (a) {
                  ...
                  return (
                    (L = Cc = (L - 16) | 0),
                    !(a |= 0) || oa((12 + Cc) | 0, 16, (Ec = xa(a))) || (Dc = wa(a, q[(12 + Cc) >> 2], Ec)) || (pa(q[(12 + Cc) >> 2]), (Dc = 0)),
                    (L = (16 + Cc) | 0),
                    0 | Dc
                  );
                },
              ...
              if (c)
                for (;;) {
                  if (((c = (c + -1) | 0), a >>> 0 < (d = ((e = (a + b) | 0) - 1) | 0) >>> 0))
                    for (;;) if (((f = r[0 | a]), (o[0 | a] = r[0 | d]), (o[0 | d] = f), !((a = (a + 1) | 0) >>> 0 < (d = (d + -1) | 0) >>> 0))) break;
                  if (((a = e), !c)) break;
                }
            }
            function Y(a, b, c) {
                  ...
                  a: {
                    if (!(Tm = q[(Sm + 16) >> 2])) {
                      if (
                        (function (a) {
                          var Rm = 0;
                          if (((Rm = r[(a + 74) | 0]), (o[(a + 74) | 0] = (Rm + -1) | Rm), 8 & (Rm = q[a >> 2]))) return ((q[a >> 2] = 32 | Rm), 1);
                          return (
                            (q[(a + 4) >> 2] = 0),
                            (q[(a + 8) >> 2] = 0),
                            (Rm = q[(a + 44) >> 2]),
                    ...
                    if (((tn = q[(Sm + 20) >> 2]), (Tm - tn) >>> 0 < Rm >>> 0)) return n[q[(Sm + 36) >> 2]](Sm, a, Rm);
                    b: if (!(o[(Sm + 75) | 0] < 0)) {
                      for (Tm = Rm; ;) {
                        if (!(Um = Tm)) break b;
                  ...
                  if (!((a = -4 & h) >>> 0 < 64 || (i = (a + -64) | 0) >>> 0 < c >>> 0))
                    for (;;)
                      if (
                        ...
                        break;
                  if (!(a >>> 0 <= c >>> 0)) for (;;) if (((q[c >> 2] = q[b >> 2]), (b = (b + 4) | 0), !((c = (c + 4) | 0) >>> 0 < a >>> 0))) break;
                }
                if (c >>> 0 < h >>> 0) for (;;) if (((o[0 | c] = r[0 | b]), (b = (b + 1) | 0), (0 | h) == (0 | (c = (c + 1) | 0)))) break;
              }
            }
            function aa(a) {
              var b, c;
            ...
            function da(a, n) {
              var p;
              if (a >>> 0 < (n = (((a + n) | 0) - 1) | 0) >>> 0) for (;;) if (((p = r[0 | a]), (o[0 | a] = r[0 | n]), (o[0 | n] = p), !((a = (a + 1) | 0) >>> 0 < (n = (n + -1) | 0) >>> 0))) break;
            }
            function ea(a) {
              var n = 0,
                o = N();
            ...
            function ga(a, q, v) {
              ...
              if (((1 == (0 | q)) & (a >>> 0 < 0)) | (q >>> 0 < 1)) x = a;
                ...
                for (;;)
                  if (((y = ad((x = bd(a, q, 10)), (z = M), 10)), (o[0 | (v = (v + -1) | 0)] = (a - y) | 48), (y = ((9 == (0 | q)) & (4294967295 < a >>> 0)) | (9 < q >>> 0)), (a = x), (q = z), !y))
                    break;
              if (x) for (;;) if (((o[0 | (v = (v + -1) | 0)] = (x - w((a = ((x >>> 0) / 10) | 0), 10)) | 48), (q = 9 < x >>> 0), (x = a), !q)) break;
              return v;
            }
            function ha(a) {
              return (a + -48) >>> 0 < 10;
            ...
            function la(a, v, D, V, W) {
              var X,
                ...
                Z = 0,
                _ = 0;
              ((L = X = (L - 240) | 0), (Y = q[v >> 2]), (q[(232 + X) >> 2] = Y), (v = q[(v + 4) >> 2]), (q[X >> 2] = a), (q[(236 + X) >> 2] = v), (Z = 1));
              a: {
                b: {
                  c: {
                ...
                if (8 == (0 | v)) v = qa($);
                  ...
                  v = (function (a, Vk) {
                    ...
                    if (((tl = a >>> 0 > (ql = 16) ? a : 16) + -1) & tl) {
                      for (;;) if (((ql = (a = ql) << 1), !(a >>> 0 < tl >>> 0))) break;
                    } else a = tl;
                    if ((-64 - a) >>> 0 <= Vk >>> 0) return ((q[2086] = 48), 0);
                    if (!(ql = qa((12 + (((tl = Vk >>> 0 < 11 ? 16 : (Vk + 11) & -8) + a) | 0)) | 0))) return 0;
                    Vk = (ql + -8) | 0;
                    ql & (a + -1)
                      ? ((wl = q[(vl = (ql + -4) | 0) >> 2]),
                        (ul = ((-8 & wl) - (ql = ((a = 15 < ((ql = (((((a + ql) | 0) - 1) & (0 - a)) - 8) | 0) - Vk) >>> 0 ? ql : (a + ql) | 0) - Vk) | 0)) | 0),
                        3 & wl
                ...
                b: if (!(1 & $)) {
                  ...
                  if (((a = (a + $) | 0), q[2092] != (0 | ba)))
                    if ($ >>> 0 <= 255)
                      ((ca = q[(ba + 8) >> 2]),
                        ($ >>>= 3),
                        (0 | (v = q[(ba + 12) >> 2])) == (0 | ca) ? ((ha = q[2087] & dd($)), (q[8348 >> 2] = ha)) : ((q[(ca + 12) >> 2] = v), (q[(v + 8) >> 2] = ca)));
                    else {
                      if (((fa = q[(ba + 24) >> 2]), (0 | ba) != (0 | ($ = q[(ba + 12) >> 2])))) ((v = q[(ba + 8) >> 2]), (q[(v + 12) >> 2] = $), (q[($ + 8) >> 2] = v));
                      else if ((v = q[(ca = (ba + 20) | 0) >> 2]) || (v = q[(ca = (ba + 16) | 0) >> 2])) {
                        for (;;) if (((ea = ca), !((v = q[(ca = (($ = v) + 20) | 0) >> 2]) || ((ca = ($ + 16) | 0), (v = q[($ + 16) >> 2]))))) break;
                        q[ea >> 2] = 0;
                      } else $ = 0;
                      if (fa) {
                        ca = q[(ba + 28) >> 2];
                  ...
                  else if (3 == (3 & ($ = q[(4 + da) >> 2]))) return ((q[2089] = a), (q[(4 + da) >> 2] = -2 & $), (q[(ba + 4) >> 2] = 1 | a), void (q[(a + ba) >> 2] = a));
                }
                if (!(da >>> 0 <= ba >>> 0) && 1 & ($ = q[(4 + da) >> 2])) {
                  f: {
                    if (!(2 & $)) {
                      ...
                      if (q[2092] == (0 | da)) return ((q[2092] = ba), (a = (q[2089] + a) | 0), (q[2089] = a), (q[(ba + 4) >> 2] = 1 | a), void (q[(a + ba) >> 2] = a));
                      a = ((-8 & $) + a) | 0;
                      g: if ($ >>> 0 <= 255)
                        (($ >>>= 3),
                          (0 | (v = q[(8 + da) >> 2])) == (0 | (ca = q[(12 + da) >> 2])) ? ((ha = q[2087] & dd($)), (q[8348 >> 2] = ha)) : ((q[(v + 12) >> 2] = ca), (q[(ca + 8) >> 2] = v)));
                      else {
                  ...
                  m: if ((ca = q[2088]) & ($ = 1 << v)) {
                    ...
                    n: {
                      for (;;) {
                        ...
                        if ((($ = ca >>> 29), (ca <<= 1), !($ = q[((ea = (v + (4 & $)) | 0) + 16) >> 2]))) break;
                      }
                  ...
                  if (((a = (q[2095] + -1) | 0), !(q[2095] = a))) {
                    for (ba = 8804; ;) if (((ba = ((a = q[ba >> 2]) + 8) | 0), !a)) break;
                    q[2095] = -1;
                  }
                }
              }
            ...
            function qa(a) {
              ...
              a: {
                b: {
                                  ...
                                  k: {
                                    if (a >>> 0 <= 244) {
                                      if (3 & (ia = (ma = q[2087]) >>> (a = (na = a >>> 0 < 11 ? 16 : (a + 11) & -8) >>> 3))) {
                                        ((a = ((ia = q[((la = (ja = (a + (1 & (-1 ^ ia))) | 0) << 3) + 8396) >> 2]) + 8) | 0),
                                          (0 | (ka = q[(ia + 8) >> 2])) == (0 | (la = (la + 8388) | 0))
                                            ? ((ua = dd(ja) & ma), (q[8348 >> 2] = ua))
                                        ...
                                        ((ja = ia = ((a = (((0 - (a = ((0 - (ja = 2 << a)) | ja) & (ia << a))) & a) - 1) | 0) >>> 12) & 16),
                                          (ia =
                                            q[
                                              ((ka =
                                                (ja =
                                                  (((ja = (ja |= ia = ((a >>>= ia) >>> 5) & 8) | (ia = ((a >>>= ia) >>> 2) & 4) | (ia = ((a >>>= ia) >>> 1) & 2)) | (ia = ((a >>>= ia) >>> 1) & 1)) +
                                                    (a >>> ia)) |
                                                  0) << 3) +
                                                8396) >>
                                                2
                                            ]),
                                          (0 | (a = q[(ia + 8) >> 2])) == (0 | (ka = (ka + 8388) | 0)) ? ((ma = dd(ja) & ma), (q[2087] = ma)) : ((q[(a + 12) >> 2] = ka), (q[(ka + 8) >> 2] = a)),
                                          (a = (ia + 8) | 0),
                                          (q[(ia + 4) >> 2] = 3 | na),
                                          (q[((oa = (ia + na) | 0) + 4) >> 2] = 1 | (la = ((ja <<= 3) - na) | 0)),
                                          (q[(ia + ja) >> 2] = la),
                                          pa &&
                                            ((ia = (8388 + ((ja = pa >>> 3) << 3)) | 0),
                                            (ka = q[2092]),
                                      ...
                                      for (;;) if (((oa = ja), !((a = q[(ja = ((la = a) + 20) | 0) >> 2]) || ((ja = (la + 16) | 0), (a = q[(la + 16) >> 2]))))) break;
                                      q[oa >> 2] = 0;
                                      break b;
                                    }
                                    if (((na = -1), !(4294967231 < a >>> 0) && ((na = -8 & (ia = (a + 11) | 0)), (pa = q[2088])))) {
                                      ...
                                      q: {
                                          ...
                                          if (!(a | la)) {
                                            ...
                                            ((ka = ia = ((a = ((a & (0 - a)) - 1) | 0) >>> 12) & 16),
                                              (a =
                                                q[
                                                  (8652 +
                                                    ((((ka = (ka |= ia = ((a >>>= ia) >>> 5) & 8) | (ia = ((a >>>= ia) >>> 2) & 4) | (ia = ((a >>>= ia) >>> 1) & 2)) | (ia = ((a >>>= ia) >>> 1) & 1)) +
                                                      (a >>> ia)) <<
                                                      2)) >>
                                                    2
                                                ]));
                                        ...
                                        for (;;)
                                          if (
                                            ((ja = (ia = (ka = ((-8 & q[(a + 4) >> 2]) - na) | 0) >>> 0 < ja >>> 0) ? ka : ja), (la = ia ? a : la), !(a = (ia = q[(a + 16) >> 2]) || q[(a + 20) >> 2]))
                                          )
                                            break;
                                      }
                                      if (!(!la | (ja >>> 0 >= (q[2089] - na) >>> 0))) {
                                        ...
                                        for (;;) if (((ma = ka), !((a = q[(ka = ((ia = a) + 20) | 0) >> 2]) || ((ka = (ia + 16) | 0), (a = q[(ia + 16) >> 2]))))) break;
                                        q[ma >> 2] = 0;
                                        break c;
                                      }
                                    }
                                  ...
                                  if (na >>> 0 <= (ia = q[2089]) >>> 0) {
                                    ((a = q[2092]),
                                      16 <= (ja = (ia - na) | 0) >>> 0
                                        ...
                                        : ((q[2092] = 0), (q[2089] = 0), (q[(a + 4) >> 2] = 3 | ia), (q[((ia = (a + ia) | 0) + 4) >> 2] = 1 | q[(ia + 4) >> 2])),
                                      (a = (a + 8) | 0));
                                    break a;
                                  }
                                  if (na >>> 0 < (ka = q[2090]) >>> 0) {
                                    ...
                                    (ja =
                                      (ma =
                                        ((ja = la = (na + 47) | (a = 0)) +
                                          (ia = q[2205]
                                            ? q[2207]
                                            : ((q[2208] = -1), (q[2209] = -1), (q[2206] = 4096), (q[2207] = 4096), (q[2205] = ((12 + sa) & -16) ^ 1431655768), (q[2210] = 0), (q[2198] = 0), 4096))) |
                                        0) & (oa = (0 - ia) | 0)) >>>
                                      0 <=
                                    na >>> 0
                                  )
                      ...
                      x: {
                        y: {
                          z: {
                            ...
                            for (((a = q[2091]) >>> 0 <= ia >>> 0 && a) || (q[2091] = ia), a = 0, q[2200] = ma, q[2199] = ia, q[2095] = -1, q[2096] = q[2205], q[2202] = 0; ;)
                              if (((q[((ja = a << 3) + 8396) >> 2] = ka = (ja + 8388) | 0), (q[(ja + 8400) >> 2] = ka), 32 == (0 | (a = (a + 1) | 0)))) break;
                            ...
                            C: {
                              D: {
                                ...
                                if (
                                  ((q[a >> 2] = ia),
                                  (q[(a + 4) >> 2] = q[(a + 4) >> 2] + ma),
                                  (q[((qa = (((ia + 8) & 7 ? (-8 - ia) & 7 : 0) + ia) | 0) + 4) >> 2] = 3 | na),
                                ...
                                if (1 == (3 & (ja = q[(ia + 4) >> 2]))) {
                                  ...
                                  G: if (ja >>> 0 <= 255)
                                    ((la = ja >>> 3),
                                      (ja = q[(ia + 8) >> 2]),
                                      (0 | (ka = q[(ia + 12) >> 2])) == (0 | ja) ? ((ua = q[2087] & dd(la)), (q[8348 >> 2] = ua)) : ((q[(ja + 12) >> 2] = ka), (q[(ka + 8) >> 2] = ja)));
                                  else {
                                    if (((pa = q[(ia + 24) >> 2]), (0 | (ma = q[(ia + 12) >> 2])) != (0 | ia))) ((ja = q[(ia + 8) >> 2]), (q[(ja + 12) >> 2] = ma), (q[(ma + 8) >> 2] = ja));
                                    else if ((na = q[(ka = (ia + 20) | 0) >> 2]) || (na = q[(ka = (ia + 16) | 0) >> 2])) {
                                      for (;;) if (((ja = ka), !((na = q[(ka = ((ma = na) + 20) | 0) >> 2]) || ((ka = (ma + 16) | 0), (na = q[(ma + 16) >> 2]))))) break;
                                      q[ja >> 2] = 0;
                                    } else ma = 0;
                                    if (pa) {
                                      ja = q[(ia + 28) >> 2];
                                ...
                                if (
                                  ...
                                  (ka = a >>> 8) &&
                                    ...
                                    16777215 < a >>> 0 ||
                                      (ia =
                                        (28 +
                                          (((ia =
                                            ((((na = (ka <<= la = ((ka + 1048320) >>> 16) & 8) << (ia = ((ka + 520192) >>> 16) & 4)) << (ka = ((na + 245760) >>> 16) & 2)) >>> 15) - (ka | ia | la)) |
                                            0) <<
                                            1) |
                                            ((a >>> (ia + 21)) & 1))) |
                                        0)),
                                  ...
                                  for (ka = a << (31 == (0 | ia) ? 0 : (25 - (ia >>> 1)) | 0), ia = q[ja >> 2]; ;) {
                                    ...
                                    if (((ia = ka >>> 29), (ka <<= 1), !(ia = q[((la = ((4 & ia) + ja) | 0) + 16) >> 2]))) break;
                                  }
                                  q[(la + 16) >> 2] = oa;
                              ...
                              for (
                                ...
                                if (((q[(a + 4) >> 2] = 7), (ia = (a + 8) | 0), (a = (a + 4) | 0), !(ia >>> 0 < la >>> 0))) break;
                              ...
                              if (
                                ...
                                (ka = la >>> 8) &&
                                  ...
                                  16777215 < la >>> 0 ||
                                    (a =
                                      (28 +
                                        (((a =
                                          ((((oa = (ka <<= ma = ((ka + 1048320) >>> 16) & 8) << (a = ((ka + 520192) >>> 16) & 4)) << (ka = ((oa + 245760) >>> 16) & 2)) >>> 15) - (ka | a | ma)) | 0) <<
                                          1) |
                                          ((la >>> (a + 21)) & 1))) |
                                      0)),
                                ...
                                for (a = la << (31 == (0 | a) ? 0 : (25 - (a >>> 1)) | 0), ia = q[ia >> 2]; ;) {
                                  ...
                                  if (((ia = a >>> 29), (a <<= 1), !(ia = q[((ma = (ka + (4 & ia)) | 0) + 16) >> 2]))) break;
                                }
                  ...
                  S: if (ja >>> 0 <= 15) ((q[(la + 4) >> 2] = 3 | (a = (ja + na) | 0)), (q[((a = (a + la) | 0) + 4) >> 2] = 1 | q[(a + 4) >> 2]));
                    ...
                    V: {
                      if ((na = 1 << a) & pa) {
                        for (a = ja << (31 == (0 | a) ? 0 : (25 - (a >>> 1)) | 0), na = q[ia >> 2]; ;) {
                          ...
                          if (((na = a >>> 29), (a <<= 1), !(na = q[((ma = ((4 & na) + ia) | 0) + 16) >> 2]))) break;
                        }
                        q[(ma + 16) >> 2] = ka;
                ...
                (ka >>> 0 <= 15
                  ? ((q[(ia + 4) >> 2] = 3 | (a = (ka + na) | 0)), (q[((a = (a + ia) | 0) + 4) >> 2] = 1 | q[(a + 4) >> 2]))
                  : ((q[(ia + 4) >> 2] = 3 | na),
                              ...
                              j: {
                                k: {
                                  l: {
                                        ...
                                        o: {
                                          p: {
                                            q: {
                                                  ...
                                                  r: {
                                                    s: {
                                                      ...
                                                      for (Ca = 0; ;) {
                                                        ...
                                                        if (((q[(76 + Ba) >> 2] = Ma = (va + 1) | 0), (Ca = o[0 | va]), (va = Ma), !(((Ca = r[(3295 + ((Ca + w(Sa, 58)) | 0)) | 0]) + -1) >>> 0 < 8)))
                                                          break;
                                                      }
                                                      if (!Ca) break a;
                                                      A: {
                                              ...
                                              for (;;) if (q[(((va = (va + 1) | 0) << 2) + ya) >> 2] || 10 == (0 | va)) break;
                                              Ka = va >>> 0 < 10 ? -1 : 1;
                                              break a;
                                            }
                                    ...
                                    if (
                                      ((Ia = (function (a, Il, Rm) {
                                        if (a | Il) for (;;) if (((o[0 | (Rm = (Rm + -1) | 0)] = (7 & a) | 48), !((a = ((7 & Il) << 29) | (a >>> 3)) | (Il >>>= 3)))) break;
                                        return Rm;
                                ...
                                if (
                                  ((Ia = (function (a, Il, Rm, Sm) {
                                    if (a | Il) for (;;) if (((o[0 | (Rm = (Rm + -1) | 0)] = r[(3824 + (15 & a)) | 0] | Sm), !((a = ((15 & Il) << 28) | (a >>> 4)) | (Il >>>= 4)))) break;
                                    return Rm;
              ...
              if (
                (!(function (a) {
                  ...
                  q[(a + 428) >> 2] &&
                    ...
                    r[(q[a >> 2] + 4) | 0] < 4 || ((Vg = Wg << 4), $(q[(a + 472) >> 2], q[(a + 452) >> 2], Vg), $(q[(a + 476) >> 2], q[(a + 456) >> 2], Vg)));
                })(a),
                !(function (a) {
                  var fe = 0,
                    ge = x(0),
                    ...
                    ne = x(0);
                  if (1 <= (0 | (ie = q[a >> 2])))
                    for (fe = q[(a + 4) >> 2], me = (fe + w(ie, 52)) | 0, a = q[(a + 12) >> 2]; ;)
                      if (
                        ((ge = u[a >> 2]),
                        (ne = u[(fe + 44) >> 2]),
                        (ke = q[(fe + 16) >> 2]),
                        ...
                        ne != ge ? ((u[(fe + 44) >> 2] = ge), (q[(fe + 48) >> 2] = 1)) : (q[(fe + 48) >> 2] = 0),
                        ke || (u[a >> 2] = ge),
                        (a = (a + 4) | 0),
                        !((fe = (fe + 52) | 0) >>> 0 < me >>> 0))
                      )
                ...
                !(function (a) {
                  var Rd = 0,
                    ...
                    ee = 0;
                  if (1 <= (0 | (Ud = q[(a + 540) >> 2])))
                    for (Yd = q[(a + 544) >> 2], de = (Yd + w(Ud, 52)) | 0, ee = q[(a + 644) >> 2]; ;) {
                      a: if (!(q[Yd >> 2] || (0 | (Ud = q[(Yd + 32) >> 2])) < 1))
                        if (((a = q[(Yd + 28) >> 2]), (ae = (a + w(Ud, 28)) | 0), (ce = u[(Yd + 24) >> 2]), (Xd = u[(Yd + 20) >> 2]), (Wd = u[(Yd + 44) >> 2]), ee))
                          for (;;) {
                            Zd = x(($d = 0));
                            h: {
                              i: {
                              ...
                              ((Vd = u[(a + 12) >> 2]), (_d = ((Sd = Vd != Zd) & ((Zd == x(0)) | (Vd == x(0)))) | (q[(a + 8) >> 2] != (0 | Rd))), ($d = Ud));
                            }
                            if (((q[(a + 20) >> 2] = _d), (q[(a + 24) >> 2] = Sd), (u[(a + 12) >> 2] = Zd), (q[(a + 16) >> 2] = $d), (q[(a + 8) >> 2] = Rd), !((a = (a + 28) | 0) >>> 0 < ae >>> 0)))
                              break;
                          }
                        else {
                          if (!q[(Yd + 48) >> 2]) for (;;) if (((q[(a + 20) >> 2] = 0), (q[(a + 24) >> 2] = 0), !((a = (a + 28) | 0) >>> 0 < ae >>> 0))) break a;
                          for (;;) {
                            ((Zd = x(($d = 0))), (Rd = q[(_d = a) >> 2]), (Sd = 0));
                            b: {
                              c: {
                                d: {
                                  e: if (!((0 | Rd) < 1)) {
                              ...
                              (($d = Ud), (Vd = u[(a + 12) >> 2]), (be = ((Sd = Vd != Zd) & ((Zd == x(0)) | (Vd == x(0)))) | (q[(a + 8) >> 2] != (0 | Rd))));
                            }
                            if (((q[(_d + 20) >> 2] = be), (q[(a + 24) >> 2] = Sd), (u[(a + 12) >> 2] = Zd), (q[(a + 16) >> 2] = $d), (q[(a + 8) >> 2] = Rd), !((a = (a + 28) | 0) >>> 0 < ae >>> 0)))
                              break;
                          }
                        }
                ...
                !(function (a) {
                  ...
                  if (!(r[(q[a >> 2] + 4) | 0] < 4 || (0 | (kd = q[(a + 540) >> 2])) < 1))
                    for (pd = q[(a + 544) >> 2], ud = (pd + w(kd, 52)) | 0, vd = q[(a + 644) >> 2]; ;) {
                      b: if (1 == q[pd >> 2] && !((0 | (kd = q[(pd + 40) >> 2])) < 1))
                        if (((a = q[(pd + 36) >> 2]), (sd = (a + w(kd, 28)) | 0), (rd = u[(pd + 44) >> 2]), vd))
                          for (;;) {
                            ((qd = x((kd = 0))), (nd = q[a >> 2]));
                            d: if (!((0 | nd) < 2 || ((md = q[(a + 4) >> 2]), (ld = u[md >> 2]), rd <= ld))) {
                              kd = 1;
                              e: if (((od = u[(md + 4) >> 2]), !(rd < od))) {
                                for (;;) {
                                  if (((ld = od), (0 | nd) == (0 | (kd = (kd + 1) | 0)))) break;
                                  if (((od = u[(md + (kd << 2)) >> 2]), rd < od)) break e;
                                }
                                kd = (nd + -1) | 0;
                                break d;
                              }
                          ...
                          if (!q[(pd + 48) >> 2]) for (;;) if (((q[(a + 20) >> 2] = 0), (q[(a + 24) >> 2] = 0), !((a = (a + 28) | 0) >>> 0 < sd >>> 0))) break b;
                          for (;;) {
                            ((qd = x((nd = 0))), (td = q[a >> 2]));
                            c: if (!((0 | td) < 2 || ((md = q[(a + 4) >> 2]), (ld = u[md >> 2]), rd <= ld))) {
                              if (((kd = 1), (od = u[(md + 4) >> 2]), !(rd < od)))
                                for (nd = (td + -1) | 0; ;) {
                                  if (((ld = od), (0 | kd) == (0 | nd))) break c;
                                  if (((od = u[(md + ((kd = (kd + 1) | 0) << 2)) >> 2]), rd < od)) break;
                                }
                ...
                !(function (a) {
                  var wd = 0,
                    ...
                    Qd = 0;
                  if (1 <= (0 | (xd = q[(a + 564) >> 2])))
                    for (Ad = q[(a + 568) >> 2], Pd = (Ad + w(xd, 36)) | 0, Nd = q[(a + 644) >> 2]; ;) {
                      ...
                      a: {
                        ...
                        if (((wd = 0), (Kd = Nd ? 1 : yd) | (Ld = Nd ? 1 : xd) && ((Ed = 1 << zd), (q[(Ad + 12) >> 2] = Ed), 31 != (0 | zd)))) {
                          for (
                            xd = q[(Ad + 20) >> 2],
                              Od = q[Ad >> 2],
                              a = q[(Ad + 16) >> 2],
                              yd = (a + (Cd = Ed << 2)) | 0,
                              yd = ca((Fd = a), 0, (4 + (((Md = -1 ^ a) + ((a = (a + 4) | 0) >>> 0 < yd >>> 0 ? yd : a)) | 0)) & -4),
                              Cd = (xd + Cd) | 0,
                              a = xd;
                            ;
                          )
                            if (((q[a >> 2] = 1065353216), !((a = (a + 4) | 0) >>> 0 < Cd >>> 0))) break;
                          if (!Bd) {
                            if (((Bd = 0), (Cd = wd = 1), zd))
                              for (;;) {
                                if (((zd = q[((Bd << 2) + Od) >> 2]), (Gd = q[(zd + 8) >> 2]), (Hd = w(Gd, wd)), (a = 0), (Dd = u[(zd + 12) >> 2]) != x(0))) {
                                  for (q[yd >> 2] = Hd + q[yd >> 2], u[xd >> 2] = x(x(1) - Dd) * u[xd >> 2], Gd = w((Gd + (a = 1)) | 0, wd); ;)
                                    if (
                                      ((Dd = u[(zd + 12) >> 2]),
                                      (Qd = q[(Md = Fd = ((Id = a << 2) + yd) | 0) >> 2]),
                                      (Fd = a & Cd),
                                      (q[Md >> 2] = Qd + (Fd ? Gd : Hd)),
                                      (u[(Id = (xd + Id) | 0) >> 2] = (Fd ? Dd : x(x(1) - Dd)) * u[Id >> 2]),
                                      (0 | Ed) == (0 | (a = (a + 1) | 0)))
                                    )
                                      break;
                                  Cd <<= 1;
                                } else for (;;) if (((q[(Gd = (yd + (a << 2)) | 0) >> 2] = Hd + q[Gd >> 2]), (0 | Ed) == (0 | (a = (a + 1) | 0)))) break;
                                if (((wd = w(q[zd >> 2], wd)), (0 | Jd) == (0 | (Bd = (Bd + 1) | 0)))) break;
                              }
                            else
                              for (;;) {
                                if (((zd = q[((Bd << 2) + Od) >> 2]), (Cd = w(q[(zd + 8) >> 2], wd)), (a = 0), (Dd = u[(zd + 12) >> 2]) != x(0)))
                                  ((q[yd >> 2] = Cd + q[yd >> 2]), (u[xd >> 2] = x(x(1) - Dd) * u[xd >> 2]));
                                else for (;;) if (((q[(Hd = (yd + (a << 2)) | 0) >> 2] = Cd + q[Hd >> 2]), (0 | Ed) == (0 | (a = (a + 1) | 0)))) break;
                                if (((wd = w(q[zd >> 2], wd)), (0 | Jd) == (0 | (Bd = (Bd + 1) | 0)))) break;
                              }
                            wd = 0;
                          }
                ...
                !(function (a) {
                  ...
                  if (!(r[(q[a >> 2] + 4) | 0] < 4 || (0 | (Xc = q[(a + 588) >> 2])) < 1))
                    for (Zc = q[(a + 592) >> 2], jd = (Zc + w(Xc, 48)) | 0, gd = q[(a + 644) >> 2]; ;) {
                      if (((a = q[Zc >> 2]), (ed = gd ? 1 : q[(a + 20) >> 2]), (fd = gd ? 1 : q[(a + 24) >> 2]), ed | fd)) {
                        c: {
                          d: {
                            ...
                            e: {
                              if (Wc != x(0)) {
                                if (((a = (Xc + 1) | 0), (0 | Xc) == (0 | _c))) {
                                  ((ed = 1), (q[(Zc + 8) >> 2] = 1), (Wc = x(x(1) - Wc)), (fd = 1));
                                  break e;
                                }
                                a = (0 | a) == (0 | _c) ? 1 : 2;
                              }
                      ...
                      g: if ((0 | (hd = q[(Zc + 36) >> 2])) < 1) cd = x(1);
                            ...
                            h: {
                              i: {
                                if (((Xc = q[((a << 2) + id) >> 2]), (Yc = q[Xc >> 2]))) {
                                  ...
                                  if (((dd = q[(Xc + 8) >> 2]), 1 != (0 | _c) && ((ad = u[(Yc + 44) >> 2]), ($c = q[(Xc + 4) >> 2]), (bd = u[$c >> 2]), !(ad <= bd)))) break i;
                              ...
                              j: if (((Wc = u[($c + 4) >> 2]), !(ad < Wc))) {
                                for (;;) {
                                  if (((bd = Wc), (0 | _c) == (0 | (Yc = (Yc + 1) | 0)))) break;
                                  if (((Wc = u[($c + (Yc << 2)) >> 2]), ad < Wc)) break j;
                                }
                        ...
                        for (;;) {
                          ...
                          l: if (Yc && ((dd = q[(Xc + 12) >> 2]), (Wc = x(1)), !((0 | dd) < 1)) && ((_c = q[(Xc + 8) >> 2]), (Wc = u[_c >> 2]), 1 != (0 | dd))) {
                            m: {
                              if (((ad = u[(Yc + 44) >> 2]), ($c = q[(Xc + 4) >> 2]), (bd = u[$c >> 2]), ad <= bd)) {
                                Wc = u[_c >> 2];
                                break l;
                              }
                              if (((Yc = 1), (Wc = u[($c + 4) >> 2]), !(ad < Wc))) {
                                for (;;) {
                                  if (((bd = Wc), (0 | dd) == (0 | (Yc = (Yc + 1) | 0)))) break;
                                  if (((Wc = u[($c + (Yc << 2)) >> 2]), ad < Wc)) break m;
                                }
                                Wc = u[(((_c + (dd << 2)) | 0) - 4) >> 2];
                                break l;
                              }
                          ...
                          if (((u[(Xc + 16) >> 2] = Wc), (cd = cd < Wc ? cd : Wc), (0 | hd) == (0 | (a = (a + 1) | 0)))) break;
                        }
                      }
                ...
                for (Ea = ((Aa = q[(a + 52) >> 2]) + (Ea << 2)) | 0; ;) if (((ab = u[Aa >> 2]), (u[Aa >> 2] = ab < x(0) ? x(0) : x(A(ab, x(1)))), !((Aa = (Aa + 4) | 0) >>> 0 < Ea >>> 0))) break;
              (!(function (a) {
                var De = 0,
                  Ee = 0,
                  Fe = 0,
                  ...
                  He = 0;
                if (1 <= (0 | (Ee = q[(a + 4) >> 2])))
                  for (De = q[(a + 8) >> 2], He = (De + w(Ee, 12)) | 0, Fe = q[(a + 40) >> 2], a = Fe; ;)
                    if (
                      ((Ee = 0),
                  ...
                  if (1 <= (0 | (vg = q[(a + 4) >> 2])))
                    for (xg = q[(a + 8) >> 2], wg = q[a >> 2], yg = q[(wg + 724) >> 2]; ;) {
                      if (
                        ...
                        for (qg = q[(rg + 16) >> 2], sg = (qg + (sg << 2)) | 0, zg = q[(pg + yg) >> 2], pg = (q[(a + 36) >> 2] + (ug << 2)) | 0, Ag = q[(wg + 976) >> 2]; ;)
                          if (((q[pg >> 2] = q[(((q[qg >> 2] + zg) << 2) + Ag) >> 2]), (pg = (pg + 4) | 0), !((qg = (qg + 4) | 0) >>> 0 < sg >>> 0))) break;
                      if (q[(rg + 28) >> 2] && !((0 | (pg = q[(rg + 12) >> 2])) < 1))
                        for (qg = q[(rg + 20) >> 2], sg = (qg + (pg << 2)) | 0, pg = (q[(a + 32) >> 2] + (ug << 2)) | 0; ;)
                          if (((q[pg >> 2] = q[qg >> 2]), (pg = (pg + 4) | 0), !((qg = (qg + 4) | 0) >>> 0 < sg >>> 0))) break;
                ...
                (function (a) {
                  var ue = 0,
                    ...
                    Ce = 0;
                  if (1 <= (0 | (we = q[(a + 304) >> 2])))
                    for (ue = q[(a + 308) >> 2], ze = (ue + (we << 5)) | 0, Ae = q[(a + 264) >> 2], Be = q[(a + 144) >> 2], Ce = q[(a + 40) >> 2], ye = q[(a + 312) >> 2], we = ye; ;)
                      if (
                        ((xe = we),
                        (ve = 0),
                        (a = ve =
                  ...
                  if (((Yf = q[a >> 2]), 1 <= (0 | ($f = q[(a + 56) >> 2])))) {
                    for (ag = q[(a + 60) >> 2], bg = q[(Yf + 1052) >> 2], cg = q[(Yf + 784) >> 2]; ;) {
                      if (
                        ...
                        for (Wf = q[(Uf + 16) >> 2], dg = (Wf + (Xf << 2)) | 0, eg = q[(Vf + cg) >> 2], Vf = ((Xf = _f << 2) + q[(a + 92) >> 2]) | 0, Xf = (Xf + q[(a + 88) >> 2]) | 0; ;)
                          if (
                            ((fg = (eg + q[Wf >> 2]) << 2),
                      ...
                      if (q[(Uf + 28) >> 2] && !((0 | (Vf = q[(Uf + 12) >> 2])) < 1))
                        for (Wf = q[(Uf + 20) >> 2], Xf = (Wf + (Vf << 2)) | 0, Vf = (q[(a + 84) >> 2] + (_f << 2)) | 0; ;)
                          if (((q[Vf >> 2] = q[Wf >> 2]), (Vf = (Vf + 4) | 0), !((Wf = (Wf + 4) | 0) >>> 0 < Xf >>> 0))) break;
                ...
                (function (a) {
                  var xf = 0,
                    ...
                    Sf = 0,
                    Tf = 0;
                  if (((Tf = q[(a + 168) >> 2]), (zf = q[a >> 2]), 1 <= (0 | (Kf = q[(a + 164) >> 2]))))
                    for (Mf = q[(zf + 816) >> 2]; ;) {
                      ...
                      if (q[(Af + 28) >> 2] && !((0 | (yf = q[(Af + 12) >> 2])) < 1))
                        for (xf = q[(Af + 20) >> 2], yf = (xf + (yf << 2)) | 0, Bf = (q[(a + 192) >> 2] + (Df << 2)) | 0; ;)
                          if (((q[Bf >> 2] = q[xf >> 2]), (Bf = (Bf + 4) | 0), !((xf = (xf + 4) | 0) >>> 0 < yf >>> 0))) break;
                ...
                (function (a) {
                  ...
                  if (!(
                    ...
                    for (wk = q[(a + 128) >> 2], xk = q[(a + 124) >> 2], yk = q[(a + 120) >> 2], rk = q[(a + 156) >> 2], qk = 0; ;)
                      if (
                        ((uk = qk << 2),
                        ...
                        break;
                    for (rk = q[(a + 160) >> 2], uk = q[(a + 140) >> 2], wk = q[(a + 136) >> 2], xk = q[(a + 132) >> 2], qk = a = 0; ;)
                      if (
                        ((sk = qk << 2),
                ...
                (function (a) {
                  ...
                  if (!(
                    ...
                    for (nk = q[(a + 248) >> 2], ok = q[(a + 244) >> 2], pk = q[(a + 240) >> 2], ik = q[(a + 296) >> 2], hk = 0; ;)
                      if (
                        ((lk = hk << 2),
                        ...
                        break;
                    for (ik = q[(a + 300) >> 2], lk = q[(a + 260) >> 2], nk = q[(a + 256) >> 2], ok = q[(a + 252) >> 2], hk = a = 0; ;)
                      if (
                        ((jk = hk << 2),
                ...
                (function (a) {
                  var oe = 0,
                    ...
                    te = 0;
                  if (1 <= (0 | (pe = q[(a + 332) >> 2])))
                    for (oe = q[(a + 336) >> 2], re = (oe + w(pe, 20)) | 0, se = q[(a + 312) >> 2], te = q[(a + 40) >> 2], a = q[(a + 424) >> 2]; ;)
                      if (
                        ((pe = 0),
                        q[(oe + 12) >> 2] &&
                  ...
                  if (((cf = q[a >> 2]), 1 <= (0 | (jf = q[(a + 332) >> 2])))) {
                    for (kf = q[(a + 336) >> 2], lf = q[(cf + 1052) >> 2], mf = q[(cf + 856) >> 2]; ;) {
                      ...
                      if (q[($e + 28) >> 2] && !((0 | (af = q[($e + 12) >> 2])) < 1))
                        for (bf = q[($e + 20) >> 2], df = (bf + (af << 2)) | 0, af = (q[(a + 360) >> 2] + (gf << 2)) | 0; ;)
                          if (((q[af >> 2] = q[bf >> 2]), (af = (af + 4) | 0), !((bf = (bf + 4) | 0) >>> 0 < df >>> 0))) break;
                ...
                (function (a) {
                  ...
                  if (!(
                    ...
                    for (ek = q[(a + 408) >> 2], fk = q[(a + 404) >> 2], gk = q[(a + 400) >> 2], xj = q[(a + 452) >> 2], vj = 0; ;)
                      if (
                        ((ck = vj << 2),
                        ...
                        break;
                    for (xj = q[(a + 456) >> 2], ck = q[(a + 420) >> 2], ek = q[(a + 416) >> 2], fk = q[(a + 412) >> 2], vj = a = 0; ;)
                      if (
                        ((yj = vj << 2),
                  ...
                  if (1 <= (0 | (Ve = q[(a + 500) >> 2])))
                    for (Xe = q[(a + 504) >> 2], We = q[a >> 2], Ye = q[(We + 1252) >> 2]; ;) {
                      if (
                        ...
                        for (Qe = q[(Re + 16) >> 2], Se = (Qe + (Se << 2)) | 0, Ze = q[(Pe + Ye) >> 2], Pe = (q[(a + 532) >> 2] + (Ue << 2)) | 0, _e = q[(We + 1284) >> 2]; ;)
                          if (((q[Pe >> 2] = q[(((q[Qe >> 2] + Ze) << 2) + _e) >> 2]), (Pe = (Pe + 4) | 0), !((Qe = (Qe + 4) | 0) >>> 0 < Se >>> 0))) break;
                      if (q[(Re + 28) >> 2] && !((0 | (Pe = q[(Re + 12) >> 2])) < 1))
                        for (Qe = q[(Re + 20) >> 2], Se = (Qe + (Pe << 2)) | 0, Pe = (q[(a + 528) >> 2] + (Ue << 2)) | 0; ;)
                          if (((q[Pe >> 2] = q[Qe >> 2]), (Pe = (Pe + 4) | 0), !((Qe = (Qe + 4) | 0) >>> 0 < Se >>> 0))) break;
                ...
                (function (a) {
                  ...
                  if (!(r[(Ck + 4) | 0] < 5 || (0 | (Dk = q[(a + 596) >> 2])) < 1))
                    for (Bk = q[(a + 600) >> 2], Hk = (Bk + w(Dk, 12)) | 0, Ik = q[(a + 44) >> 2], Dk = q[(Ck + 976) >> 2]; ;) {
                ...
                (function (a) {
                  ...
                  if (!(r[(ej + 4) | 0] < 4 || (va(a, q[(a + 604) >> 2], q[(a + 608) >> 2], q[(ej + 984) >> 2], q[(a + 152) >> 2], q[(ej + 796) >> 2]), (gj = q[a >> 2]), r[(gj + 4) | 0] < 5))) {
                    if (((ij = q[(a + 608) >> 2]), (qj = q[(gj + 992) >> 2]), (rj = q[(gj + 988) >> 2]), 1 <= (0 | (ej = q[(a + 604) >> 2])))) {
                      for (sj = (w(ej, 12) + ij) | 0, tj = q[(a + 148) >> 2], nj = q[(gj + 980) >> 2]; ;) {
                        if (((oj = ((q[ij >> 2] << 2) + tj) | 0), (kj = q[oj >> 2]), 1 <= (0 | (jj = q[(ij + 4) >> 2]))))
                          for (ej = q[(ij + 8) >> 2], uj = (ej + w(jj, 48)) | 0; ;)
                            if (
                              ((jj = q[(ej + 8) >> 2]) &&
                                ((pj = (jj + -1) | 0) >>> 0 <= 1
                                  ? ((jj = q[(ej + 4) >> 2]),
                ...
                (function (a) {
                  ...
                  if (!(r[(wi + 4) | 0] < 5)) {
                    if (((Ei = q[(wi + 1028) >> 2]), (Fi = q[(wi + 1024) >> 2]), (ti = q[(a + 616) >> 2]), (si = q[(a + 612) >> 2]), (ui = ti), !((0 | si) < 1))) {
                      for (Ai = (w(si, 12) + ti) | 0, Bi = q[(a + 276) >> 2], yi = q[(wi + 1004) >> 2]; ;) {
                        if (((Ci = (Bi + (q[ti >> 2] << 2)) | 0), (ui = q[Ci >> 2]), 1 <= (0 | (vi = q[(ti + 4) >> 2]))))
                          for (si = q[(ti + 8) >> 2], Gi = (si + w(vi, 48)) | 0; ;)
                            if (
                              ((vi = q[(si + 8) >> 2]) &&
                                ((Di = (vi + -1) | 0) >>> 0 <= 1
                                  ? ((vi = q[(si + 4) >> 2]),
                                      ...
                                      (j(
                                        x(
                                          Di - 1
                                            ...
                                            : x(u[(si + 44) >> 2] * x(x(xi * u[(si + 20) >> 2]) + x(u[(yi + ((vi + q[(si + 16) >> 2]) << 2)) >> 2] * u[(si + 24) >> 2]))) + (f(0, ui), k())
                                        )
                                      ),
                                      b[0])))
                                  : ((q[(64 + zi) >> 2] = vi), Y(4, 1024, (zi + 64) | 0))),
                              !((si = (si + 48) | 0) >>> 0 < Gi >>> 0))
                            )
                              break;
                        if (((q[Ci >> 2] = ui), !((ti = (ti + 12) | 0) >>> 0 < Ai >>> 0))) break;
                      }
                      if (((ti = q[(a + 616) >> 2]), (si = q[(a + 612) >> 2]), (ui = ti), !((0 | si) < 1))) {
                    ...
                    if (
                      ...
                      fa(q[(a + 612) >> 2], q[(a + 616) >> 2], Ei, q[(wi + 1300) >> 2], q[(wi + 1304) >> 2], q[(wi + 1308) >> 2], q[(a + 300) >> 2]),
                      !((0 | (si = q[(a + 612) >> 2])) < 1))
                    ) {
                      for (ti = q[(a + 616) >> 2], vi = (ti + w(si, 12)) | 0, Ei = q[(a + 284) >> 2], wi = q[(q[a >> 2] + 1e3) >> 2]; ;) {
                        if (((Fi = (Ei + (q[ti >> 2] << 2)) | 0), (ui = q[Fi >> 2]), 1 <= (0 | (yi = q[(ti + 4) >> 2]))))
                          for (si = q[(ti + 8) >> 2], Ai = (si + w(yi, 48)) | 0; ;)
                            if (
                              ((yi = q[(si + 8) >> 2]) &&
                                ((Bi = (yi + -1) | 0) >>> 0 <= 1
                                  ? ((yi = q[(si + 4) >> 2]),
                                    ...
                                    (ui =
                                      (j(
                                        x(
                                          Bi - 1
                                            ? x(u[(si + 44) >> 2] * x(xi * u[(si + 20) >> 2])) + (f(0, ui), k())
                                            : x(u[(si + 44) >> 2] * x(x(xi * u[(si + 20) >> 2]) + x(u[(wi + ((yi + q[(si + 16) >> 2]) << 2)) >> 2] * u[(si + 24) >> 2]))) + (f(0, ui), k())
                                        )
                                      ),
                                      b[0])))
                      ...
                      if (!((0 | (si = q[(a + 612) >> 2])) < 1))
                        for (ti = q[(a + 616) >> 2], yi = (ti + w(si, 12)) | 0, vi = q[(a + 272) >> 2], a = q[(q[a >> 2] + 1012) >> 2]; ;) {
                          if (((Ei = (vi + (q[ti >> 2] << 2)) | 0), (ui = q[Ei >> 2]), 1 <= (0 | (wi = q[(ti + 4) >> 2]))))
                            for (si = q[(ti + 8) >> 2], Fi = (si + w(wi, 48)) | 0; ;)
                              if (
                                ((wi = q[(si + 8) >> 2]) &&
                                  ((Ai = (wi + -1) | 0) >>> 0 <= 1
                                    ? ((wi = q[(si + 4) >> 2]),
                                      ...
                                      (ui =
                                        (j(
                                          x(
                                            Ai - 1
                                              ? x(u[(si + 44) >> 2] * x(xi * u[(si + 20) >> 2])) + (f(0, ui), k())
                                              : x(u[(si + 44) >> 2] * x(x(xi * u[(si + 20) >> 2]) + x(u[(a + ((wi + q[(si + 16) >> 2]) << 2)) >> 2] * u[(si + 24) >> 2]))) + (f(0, ui), k())
                                          )
                                        ),
                                        b[0])))
                ...
                (function (a) {
                  var Vh = 0,
                    ...
                    ii = 0;
                  ((L = $h = (L - 32) | 0), (Xh = q[a >> 2]));
                  if (!(r[(Xh + 4) | 0] < 4 || (va(a, q[(a + 620) >> 2], q[(a + 624) >> 2], q[(Xh + 1040) >> 2], q[(a + 444) >> 2], q[(Xh + 892) >> 2]), (_h = q[a >> 2]), r[(_h + 4) | 0] < 5))) {
                    if (((hi = q[(_h + 1048) >> 2]), (ii = q[(_h + 1044) >> 2]), (Yh = q[(a + 624) >> 2]), (Vh = q[(a + 620) >> 2]), (Xh = Yh), !((0 | Vh) < 1))) {
                      for (di = (w(Vh, 12) + Yh) | 0, ei = q[(a + 440) >> 2], ai = q[(_h + 1036) >> 2]; ;) {
                        if (((Xh = (ei + (q[Yh >> 2] << 2)) | 0), (Zh = x(q[Xh >> 2])), 1 <= (0 | (Wh = q[(Yh + 4) >> 2]))))
                          for (Vh = q[(Yh + 8) >> 2], bi = (Vh + w(Wh, 48)) | 0; ;)
                            if (
                              ((Wh = q[(Vh + 8) >> 2]) &&
                                ((ci = (Wh + -1) | 0) >>> 0 <= 1
                                  ? ((Wh = q[(Vh + 4) >> 2]),
                ...
                (function (a) {
                  ...
                  if (!(r[(Cg + 4) | 0] < 5 || (0 | (Eg = q[(a + 628) >> 2])) < 1))
                    for (Dg = q[(a + 632) >> 2], Jg = (Dg + w(Eg, 12)) | 0, Kg = q[(a + 536) >> 2], Eg = q[(Cg + 1284) >> 2]; ;) {
                                    ...
                                    (j(
                                      x(
                                        Ig - 1
                                          ...
                                          : x(u[(a + 44) >> 2] * x(x(Fg * u[(a + 20) >> 2]) + x(u[(Eg + ((Bg + q[(a + 16) >> 2]) << 2)) >> 2] * u[(a + 24) >> 2]))) + (f(0, Cg), k())
                                      )
                                    ),
                                    b[0])))
                ...
                (function (a) {
                  var mh = 0,
                    ...
                    Th = 0;
                  if (1 <= (0 | (mh = q[(a + 4) >> 2])))
                    for (Oh = q[(a + 8) >> 2], Th = (Oh + w(mh, 12)) | 0, mh = q[(a + 40) >> 2], Ph = q[(a + 52) >> 2], Qh = q[(a + 48) >> 2], a = Qh; ;)
                      if (
                ...
                (function (a) {
                  ...
                  if (1 <= (0 | (lh = q[(a + 304) >> 2])))
                    for (ih = q[(a + 308) >> 2], jh = q[(a + 312) >> 2]; ;)
                      if ((q[jh >> 2] && n[q[(ih + 20) >> 2]](a, kh), (jh = (jh + 4) | 0), (ih = (ih + 32) | 0), (0 | lh) == (0 | (kh = (kh + 1) | 0)))) break;
                })(a),
                (function (a) {
                  var Xg = 0,
                    Yg = 0,
                  ...
                  if (!(r[(q[a >> 2] + 4) | 0] < 4 || (0 | (Xg = q[(a + 332) >> 2])) < 1))
                    for ($g = q[(a + 336) >> 2], ah = ($g + w(Xg, 20)) | 0, eh = q[(a + 328) >> 2], fh = q[(a + 324) >> 2], Yg = q[(a + 452) >> 2], Xg = q[(a + 456) >> 2], bh = q[(a + 424) >> 2]; ;)
                      if (
                        (q[bh >> 2] &&
                          -1 != (0 | (a = q[($g + 8) >> 2])) &&
                          ((a = ((dh = a << 4) + fh) | 0),
                ...
                (function (a) {
                  var Gc = 0,
                    ...
                    Vc = 0;
                  if (!((0 | (Rc = q[(a + 480) >> 2])) < 1)) {
                    for (Sc = q[(a + 484) >> 2], Kc = (Sc + w(Rc, 28)) | 0, Nc = q[(a + 424) >> 2], Oc = q[(a + 40) >> 2], Lc = q[(a + 44) >> 2], Tc = q[(a + 440) >> 2], Gc = Sc; ;) {
                      if (1 <= (0 | (Mc = q[(Gc + 4) >> 2])))
                        for (Qc = (Gc + 20) | 0, Pc = q[(Gc + 12) >> 2], Ic = 0; ;)
                          if (
                            ((Uc = q[((Jc = (Pc + (Ic << 4)) | 0) + 4) >> 2] << 2),
                            (Jc = 1 == q[(Vc = Jc) >> 2]),
                    ...
                    if (!((0 | Rc) < 1))
                      for (Tc = q[(a + 436) >> 2], Oc = 0; ;) {
                        if (((Kc = (w(Oc, 28) + Sc) | 0), !(q[((Nc = Kc) + 24) >> 2] < 1))) {
                          for (Jc = q[(a + 488) >> 2], Ic = 0; ;) if (((q[(Jc + (Ic << 2)) >> 2] = -1), (Ic = (Ic + 1) | 0), (Gc = q[(Nc + 24) >> 2]), !((0 | Ic) < (0 | Gc)))) break;
                          if (!((0 | Gc) < 1)) for (Gc = q[(a + 496) >> 2], Ic = 0; ;) if (((q[(Gc + (Ic << 2)) >> 2] = -1), !((0 | (Ic = (Ic + 1) | 0)) < q[(Nc + 24) >> 2]))) break;
                        }
                        if (!(q[(Kc + 4) >> 2] < 1)) {
                          for (Lc = q[(a + 492) >> 2], Ic = 0; ;) if (((q[(Lc + (Ic << 2)) >> 2] = -1), (Ic = (Ic + 1) | 0), (Gc = q[(Kc + 4) >> 2]), !((0 | Ic) < (0 | Gc)))) break;
                          if (!((0 | Gc) < 1))
                            for (Mc = q[(Kc + 12) >> 2], Qc = q[(a + 496) >> 2], Ic = 0; ;)
                              if (
                      ...
                      if (4 <= Mg >>> 0) {
                        for (;;)
                          if (
                            ...
                            (Rg = (Ng + q[(a + 472) >> 2]) | 0),
                            ((u[Pg >> 2] != u[Rg >> 2]) | (u[(Pg + 4) >> 2] != u[(Rg + 4) >> 2]) | ((u[(Pg + 8) >> 2] != u[(Rg + 8) >> 2]) | (u[(Pg + 12) >> 2] != u[(Rg + 12) >> 2])) ||
                              ((Pg = (Ng + q[(a + 456) >> 2]) | 0),
                              (Ng = (Ng + q[(a + 476) >> 2]) | 0),
                              (u[Pg >> 2] != u[Ng >> 2]) | (u[(Pg + 4) >> 2] != u[(Ng + 4) >> 2]) | (u[(Pg + 8) >> 2] != u[(Ng + 8) >> 2])) ||
                              u[(Pg + 12) >> 2] != u[(Ng + 12) >> 2]) &&
                              (Mg |= 64),
                            (o[0 | Tg] = Mg),
                            (Ug = (Ug + 4) | 0),
                        ...
                        b: if (($a = q[(Wa + 8) >> 2])) {
                          c: {
                            if ((bb = ($a + -1) | 0) >>> 0 <= 1) {
                              ...
                              for (eb = ((q[($a + (q[(Wa + 16) >> 2] << 2)) >> 2] << 2) + gb) | 0, $a = 0; ;)
                                if (
                                  ((u[(jb = ((bb = $a << 2) + hb) | 0) >> 2] =
                                    u[jb >> 2] + x(u[(Wa + 44) >> 2] * x(x(u[(bb + ib) >> 2] * u[(Wa + 20) >> 2]) + x(u[(bb + eb) >> 2] * u[(Wa + 24) >> 2])))),
                                  (0 | db) == (0 | ($a = ($a + 1) | 0)))
                                )
                                  break;
                              break b;
                          ...
                          for ($a = 0; ;)
                            if (((u[(eb = ((bb = $a << 2) + hb) | 0) >> 2] = u[eb >> 2] + x(u[(Wa + 44) >> 2] * x(u[(bb + ib) >> 2] * u[(Wa + 20) >> 2]))), (0 | db) == (0 | ($a = ($a + 1) | 0))))
                              break;
                        }
                        if (!((Wa = (Wa + 48) | 0) >>> 0 < fb >>> 0)) break;
                      }
                    else for (;;) if ((3 <= ($a = q[(Wa + 8) >> 2]) >>> 0 && ((q[(16 + cb) >> 2] = $a), Y(4, 1024, (16 + cb) | 0)), !((Wa = (Wa + 48) | 0) >>> 0 < fb >>> 0))) break;
                        ...
                        (Wa = (function (a, Il, Jl) {
                          ...
                          if ((ca((16 + (L = cm = (L - 576) | 0)) | 0, 0, 560), Fa(a, (16 + cm) | 0, (12 + cm) | 0), (dm = q[(12 + cm) >> 2]) >>> 0 <= Jl >>> 0)) {
                            if (
                              ...
                              (Jl = (am + q[(96 + cm) >> 2]) | 0),
                              (q[($l + 152) >> 2] = Jl),
                              !((0 | (dm = q[(Il + 8) >> 2])) < 1) && ((Il = (am + q[(100 + cm) >> 2]) | 0), (q[Jl >> 2] = Il), 1 != (0 | dm)))
                            )
                              for (Jl = 1; ;)
                                if (
                            ...
                            if (
                              ...
                              (Jl = (am + q[(332 + cm) >> 2]) | 0),
                              (q[($l + 444) >> 2] = Jl),
                              !((0 | (dm = q[(Il + 16) >> 2])) < 1) && ((bm = (am + q[(336 + cm) >> 2]) | 0), (q[Jl >> 2] = bm), (Jl = 1) != (0 | dm)))
                            )
                              for (Il = 0; ;)
                                if (
                            ...
                            if (
                              ...
                              for (bm = (am + q[(468 + cm) >> 2]) | 0, Il = (am + q[(472 + cm) >> 2]) | 0, em = (am + q[(476 + cm) >> 2]) | 0, hm = q[(a + 1072) >> 2], Jl = 0; ;)
                                if (
                                  ((dm = (gm + w(Jl, 36)) | 0),
                                  (q[(dm + 20) >> 2] = em),
                                  (q[(dm + 16) >> 2] = Il),
                            ...
                            if (((Il = q[(a + 704) >> 2]), (dm = (am + q[(516 + cm) >> 2]) | 0), (q[($l + 484) >> 2] = dm), 1 <= (0 | (Il = q[(Il + 72) >> 2]))))
                              for (bm = (am + q[(520 + cm) >> 2]) | 0, em = q[(a + 1212) >> 2], Jl = 0; ;)
                                if (((q[(12 + ((dm + w(Jl, 28)) | 0)) >> 2] = bm), (bm = ((q[(em + (Jl << 2)) >> 2] << 4) + bm) | 0), (0 | Il) == (0 | (Jl = (Jl + 1) | 0)))) break;
                            ...
                            c: {
                              if (4 <= (fm = r[(a + 4) | 0]) >>> 0) {
                                if (
                                  ...
                                  for (bm = (Jl + am) | 0, em = q[(a + 1104) >> 2], Jl = 0; ;)
                                    if (((q[(40 + ((dm + w(Jl, 48)) | 0)) >> 2] = bm), (bm = ((q[(em + (Jl << 2)) >> 2] << 2) + bm) | 0), (0 | Il) == (0 | (Jl = (Jl + 1) | 0)))) break;
                                ...
                                for (dm = (Il + am) | 0, gm = 0; ;) {
                                  e: {
                                    if ((0 | (bm = q[((Il = gm << 2) + q[(a + 952) >> 2]) >> 2])) <= 0) Il = (Il + q[($l + 636) >> 2]) | 0;
                                      ...
                                      for (Jl = q[(Il + q[(a + 948) >> 2]) >> 2], em = (bm + Jl) | 0, hm = q[(a + 1060) >> 2], bm = 0; ;)
                                        if (((bm = (q[(hm + (Jl << 2)) >> 2] + bm) | 0), !((0 | (Jl = (Jl + 1) | 0)) < (0 | em)))) break;
                            ...
                            g: if (!((0 | gm) < 1)) {
                              if (
                                ...
                                for (;;)
                                  if (
                                    ...
                                    (q[(Jl + 32) >> 2] = pm),
                                    (em = 0),
                                    (em = pm ? (q[($l + 560) >> 2] + w(q[(dm + q[(a + 948) >> 2]) >> 2], 28)) | 0 : em),
                                    (q[(Jl + 48) >> 2] = 1),
                                    (q[(Jl + 28) >> 2] = em),
                                    (q[(dm + om) >> 2] = q[bm >> 2]),
                                    (Jl = 0 < (0 | Il)),
                              ...
                              for (pm = q[(a + 960) >> 2], sm = q[(a + 944) >> 2]; ;)
                                if (
                                  ...
                                  (dm = q[(bm + pm) >> 2]),
                                  (dm = (q[(Jl + 40) >> 2] = dm) ? (q[($l + 584) >> 2] + w(q[(bm + q[(a + 956) >> 2]) >> 2], 28)) | 0 : 0),
                                  (q[(Jl + 48) >> 2] = 1),
                                  (q[(Jl + 36) >> 2] = dm),
                                  (q[(bm + om) >> 2] = q[rm >> 2]),
                                  (Jl = 0 < (0 | Il)),
                            ...
                            if (
                              (4 <= fm >>> 0 ? ((q[($l + 548) >> 2] = q[(a + 944) >> 2]), (dm = a)) : (ca(q[($l + 548) >> 2], 0, gm << 2), (dm = q[$l >> 2]), (am = q[(dm + 704) >> 2])),
                              (bm = q[(am + 52) >> 2]),
                              1 <= (0 | (q[($l + 556) >> 2] = bm)))
                            )
                              for (Jl = q[(dm + 1056) >> 2], em = q[(dm + 1192) >> 2], gm = q[(dm + 1060) >> 2], fm = q[($l + 560) >> 2]; ;)
                                if (
                            ...
                            if (((bm = q[(am + 48) >> 2]), 1 <= (0 | (q[($l + 564) >> 2] = bm)))) {
                              for (;;) {
                                if (((bm = (bm + -1) | 0), (Il = (q[($l + 568) >> 2] + w(bm, 36)) | 0), (em = q[((am = bm << 2) + q[(dm + 1072) >> 2]) >> 2]), 1 <= (0 | (q[(Il + 4) >> 2] = em))))
                                  for (Jl = 0; ;)
                                    if (
                                      ((q[(q[Il >> 2] + (Jl << 2)) >> 2] = q[($l + 560) >> 2] + w(q[(q[(dm + 1064) >> 2] + ((q[(am + q[(dm + 1068) >> 2]) >> 2] + Jl) << 2)) >> 2], 28)),
                                      (0 | em) == (0 | (Jl = (Jl + 1) | 0)))
                                    )
                                      break;
                            ...
                            if (((Il = q[am >> 2]), (0 | (q[($l + 4) >> 2] = Il)) < 1)) Jl = 0;
                              ...
                              for (fm = q[($l + 16) >> 2], Jl = 0; ;)
                                if (((bm = q[(8 + ((gm + w(q[((hm = (Il = (Il + -1) | 0) << 2) + em) >> 2], 36)) | 0)) >> 2]), (q[(fm + hm) >> 2] = bm), (Jl = (Jl + bm) | 0), !(0 < (0 | Il)))) break;
                              Il = q[($l + 4) >> 2];
                            }
                            if (((q[($l + 12) >> 2] = Il), (q[($l + 20) >> 2] = Jl), (Il = q[(am + 4) >> 2]), 1 <= (0 | (q[($l + 304) >> 2] = Il)))) {
                              for (;;)
                                if (
                                  ...
                                  (Jl = (q[($l + 308) >> 2] + (Il << 5)) | 0),
                                  (bm = Il << 2),
                                  (q[Jl >> 2] = q[($l + 568) >> 2] + w(q[(bm + q[(dm + 752) >> 2]) >> 2], 36)),
                                  ...
                                  em >>> 0 <= 1
                                    ? em - 1
                                      ? ((q[(20 + ((q[($l + 60) >> 2] + w(am, 24)) | 0)) >> 2] = Il), (q[(Jl + 24) >> 2] = 1), (q[(Jl + 20) >> 2] = 2))
                                      : ((q[(8 + ((q[($l + 168) >> 2] + w(am, 12)) | 0)) >> 2] = Il), (q[(Jl + 24) >> 2] = 3), (q[(Jl + 20) >> 2] = 4))
                                    : Y(4, 1179, 0),
                                  !(0 < (0 | Il)))
                                )
                                  break;
                            ...
                            if (((Jl = q[(am + 12) >> 2]), 1 <= (0 | (q[($l + 164) >> 2] = Jl))))
                              for (em = q[(dm + 828) >> 2], gm = q[(dm + 812) >> 2], fm = q[($l + 568) >> 2], hm = q[($l + 168) >> 2], Il = Jl; ;)
                                if (
                                  ((im = (hm + w((Il = (Il + -1) | 0), 12)) | 0), (jm = Il << 2), (q[im >> 2] = fm + w(q[(jm + gm) >> 2], 36)), (q[(im + 4) >> 2] = q[(em + jm) >> 2]), !(0 < (0 | Il)))
                                )
                                  break;
                            if (((Il = 0) | bm) < 1) em = 0;
                            else {
                              for (gm = q[($l + 68) >> 2], fm = q[($l + 60) >> 2], em = 0; ;)
                                if (((Jl = q[(q[(fm + w((bm = (bm + -1) | 0), 24)) >> 2] + 8) >> 2]), (q[(gm + (bm << 2)) >> 2] = Jl), (em = (Jl + em) | 0), !(0 < (0 | bm)))) break;
                              ((Jl = q[($l + 164) >> 2]), (bm = q[($l + 56) >> 2]));
                            }
                            if (((q[($l + 64) >> 2] = bm), (q[($l + 72) >> 2] = em), (bm = $l), 1 <= (0 | Jl))) {
                              for (gm = q[($l + 176) >> 2], fm = q[($l + 168) >> 2]; ;)
                                if (((em = q[(q[(fm + w((Jl = (Jl + -1) | 0), 12)) >> 2] + 8) >> 2]), (q[(gm + (Jl << 2)) >> 2] = em), (Il = (Il + em) | 0), !(0 < (0 | Jl)))) break;
                              Jl = q[($l + 164) >> 2];
                            }
                            if (((q[(bm + 172) >> 2] = Jl), (q[($l + 180) >> 2] = Il), (em = q[(am + 16) >> 2]), 1 <= (0 | (q[($l + 332) >> 2] = em)))) {
                              ...
                              for (bm = q[($l + 344) >> 2], Jl = 0; ;)
                                if (((Il = q[(8 + ((fm + w(q[((hm = (em = (em + -1) | 0) << 2) + gm) >> 2], 36)) | 0)) >> 2]), (q[(bm + hm) >> 2] = Il), (Jl = (Il + Jl) | 0), !(0 < (0 | em)))) break;
                              if (((q[($l + 348) >> 2] = Jl), (em = q[($l + 332) >> 2]), !((0 | (q[($l + 340) >> 2] = em)) < 1)))
                                for (Jl = em << 2, bm = q[($l + 456) >> 2], gm = q[($l + 452) >> 2]; ;)
                                  if (
                            ...
                            if (((em = q[(am + 72) >> 2]), 1 <= (0 | (q[($l + 480) >> 2] = em))))
                              for (
                                hm = q[(dm + 1208) >> 2], im = q[(dm + 1224) >> 2], jm = q[(dm + 1220) >> 2], km = q[(dm + 1216) >> 2], lm = q[(dm + 1212) >> 2], mm = q[($l + 484) >> 2], bm = 0;
                                ;
                              ) {
                                if (
                                  ((Il = (mm + w(bm, 28)) | 0),
                                  ...
                                  for (om = q[(Jl + hm) >> 2], qm = q[(Il + 12) >> 2], pm = q[(dm + 1236) >> 2], sm = q[(dm + 1228) >> 2], rm = q[(dm + 1232) >> 2], Jl = 0; ;)
                                    if (
                                      ((fm = (Jl + om) << 2),
                                      (q[((Il = (qm + (Jl << 4)) | 0) + 4) >> 2] = q[(fm + rm) >> 2]),
                                      (q[Il >> 2] = q[(fm + sm) >> 2]),
                                      (fm = q[(fm + pm) >> 2]),
                                      (q[(Il + 12) >> 2] = 0),
                                      (q[(Il + 8) >> 2] = fm),
                            ...
                            if (((Jl = q[(am + 80) >> 2]), (0 | (q[($l + 500) >> 2] = Jl)) < 1)) bm = 0;
                              ...
                              if ((0 | (Jl = q[($l + 500) >> 2])) < 1) bm = 0;
                                ...
                                for (fm = q[($l + 512) >> 2], bm = 0; ;)
                                  if (((Il = q[(8 + ((gm + w(q[((hm = (Jl = (Jl + -1) | 0) << 2) + em) >> 2], 36)) | 0)) >> 2]), (q[(fm + hm) >> 2] = Il), (bm = (Il + bm) | 0), !(0 < (0 | Jl))))
                                    break;
                                Jl = q[($l + 500) >> 2];
                              }
                            }
                            ...
                            o: if (4 <= r[(a + 4) | 0]) {
                              if (!((em = r[(dm + 4) | 0]) >>> 0 < 4)) {
                                if (((Jl = q[(am + 120) >> 2]), 1 <= (0 | (q[($l + 572) >> 2] = Jl)))) {
                                  for (fm = q[(dm + 1172) >> 2], hm = q[($l + 576) >> 2]; ;)
                                    if (
                                ...
                                if (((am = q[(dm + 704) >> 2]), (bm = q[(am + 100) >> 2]), 1 <= (0 | (q[($l + 580) >> 2] = bm))))
                                  for (gm = q[(dm + 1084) >> 2], fm = q[(dm + 1076) >> 2], hm = q[(dm + 1192) >> 2], im = q[(dm + 1080) >> 2], jm = q[($l + 584) >> 2]; ;)
                                    if (
                                ...
                                if (((bm = q[(am + 104) >> 2]), 1 <= (0 | (q[($l + 588) >> 2] = bm)))) {
                                  for (;;) {
                                    if (
                                      ((bm = (bm + -1) | 0),
                                      (Il = (q[($l + 592) >> 2] + w(bm, 48)) | 0),
                                      (em = bm << 2),
                                      (q[Il >> 2] = q[($l + 584) >> 2] + w(q[(em + q[(dm + 1088) >> 2]) >> 2], 28)),
                                      ...
                                      for (Jl = 0; ;)
                                        if (
                                          ((q[(q[(Il + 40) >> 2] + (Jl << 2)) >> 2] = q[($l + 576) >> 2] + w(q[(q[(dm + 1168) >> 2] + ((q[(em + q[(dm + 1100) >> 2]) >> 2] + Jl) << 2)) >> 2], 20)),
                                          (0 | am) == (0 | (Jl = (Jl + 1) | 0)))
                                        )
                                          break;
                                    if (!(1 <= (0 | bm))) break;
                                ...
                                if (!(em >>> 0 < 4)) {
                                  if (((em = q[(a + 704) >> 2]), (Jl = q[(em + 108) >> 2]), 1 <= (0 | (q[($l + 604) >> 2] = Jl))))
                                    for (am = q[(a + 1124) >> 2], gm = q[(a + 1128) >> 2], fm = q[(a + 1120) >> 2], hm = q[($l + 592) >> 2], im = q[($l + 608) >> 2]; ;)
                                      if (
                                  ...
                                  if (((Jl = q[(em + 112) >> 2]), 1 <= (0 | (q[($l + 620) >> 2] = Jl))))
                                    for (em = q[(a + 1148) >> 2], am = q[(a + 1152) >> 2], gm = q[(a + 1144) >> 2], fm = q[($l + 592) >> 2], hm = q[($l + 624) >> 2]; ;)
                                      if (
                                  ...
                                  if (
                                    ...
                                    for (;;) if (((q[((em = Jl << 2) + q[($l + 636) >> 2]) >> 2] = bm + (q[(em + q[(dm + 968) >> 2]) >> 2] << 2)), (0 | Il) == (0 | (Jl = (Jl + 1) | 0)))) break;
                                }
                              }
                            } else if (!(q[(am + 20) >> 2] < 1))
                              for (am = 0; ;) {
                                if (((bm = q[((gm = am << 2) + q[($l + 636) >> 2]) >> 2]), 1 <= ((Il = 0) | (Jl = q[(gm + q[(dm + 952) >> 2]) >> 2]))))
                                  for (fm = q[(gm + q[(dm + 948) >> 2]) >> 2], im = (Jl + fm) | 0, jm = q[(dm + 1060) >> 2], km = q[(dm + 1056) >> 2]; ;) {
                                    if (1 <= (0 | (hm = q[((Jl = fm << 2) + jm) >> 2])))
                                      for (em = q[(Jl + km) >> 2], lm = (hm + em) | 0, mm = q[(dm + 1192) >> 2]; ;) {
                                ...
                                if (
                                  (!(function (a, Sm) {
                                    ...
                                    a: if ((Kn = Sm << 2)) {
                                      for (q[(16 + un) >> 2] = 4, q[(20 + un) >> 2] = 4, Jn = Sm = 4, xn = 2; ;)
                                        if (((Sm = (((Jn + 4) | 0) + (yn = Sm)) | 0), (q[(((16 + un) | 0) + (xn << 2)) >> 2] = Sm), (xn = (xn + 1) | 0), (Jn = yn), !(Sm >>> 0 < Kn >>> 0))) break;
                                          ...
                                          if (
                                            ((Sm =
                                              3 == (3 & xn)
                                                ...
                                                : (t[(((16 + un) | 0) + ((Jn = (Sm + -1) | 0) << 2)) >> 2] >= (yn - a) >>> 0 ? la(a, (8 + un) | 0, Sm, 0, (16 + un) | 0) : ta(a, Sm, (16 + un) | 0),
                                      ...
                                      for (la(a, (8 + un) | 0, Sm, 0, (16 + un) | 0); ;) {
                                        e: {
                                          f: {
                                            ...
                                            ((yn = Oa((8 + un) | 0)), ma((8 + un) | 0, yn), (xn = q[(8 + un) >> 2]), (Sm = (Sm + yn) | 0));
                                            break e;
                                          }
                                          (ka((8 + un) | 0, 2),
                                            (q[(8 + un) >> 2] = 7 ^ q[(8 + un) >> 2]),
                            ...
                            if (!((r[(a + 4) | 0] < 5) | (r[(q[$l >> 2] + 4) | 0] < 4))) {
                              if (((Il = q[(a + 704) >> 2]), (Jl = q[(Il + 128) >> 2]), 1 <= (0 | (q[($l + 596) >> 2] = Jl))))
                                for (em = q[(a + 1112) >> 2], am = q[(a + 1116) >> 2], gm = q[(a + 1108) >> 2], fm = q[($l + 592) >> 2], hm = q[($l + 600) >> 2]; ;)
                                  if (
                              ...
                              if (((Jl = q[(Il + 132) >> 2]), 1 <= (0 | (q[($l + 612) >> 2] = Jl))))
                                for (em = q[(a + 1136) >> 2], am = q[(a + 1140) >> 2], gm = q[(a + 1132) >> 2], fm = q[($l + 592) >> 2], hm = q[($l + 616) >> 2]; ;)
                                  if (
                                    ((dm = (hm + w((Jl = (Jl + -1) | 0), 12)) | 0),
                                    (bm = Jl << 2),
                                    (q[dm >> 2] = q[(bm + gm) >> 2]),
                              ...
                              if (((Jl = q[(Il + 136) >> 2]), !((0 | (q[($l + 628) >> 2] = Jl)) < 1)))
                                for (dm = q[(a + 1160) >> 2], bm = q[(a + 1164) >> 2], em = q[(a + 1156) >> 2], am = q[($l + 592) >> 2], gm = q[($l + 632) >> 2]; ;)
                                  if (
                ...
                b: if (!(1 & (_a = q[(a + 4) >> 2]))) {
                  ...
                  if (((Za = ((_a = q[a >> 2]) + Za) | 0), (0 | (a = (a - _a) | 0)) != q[2092]))
                    if (_a >>> 0 <= 255)
                      ((mb = _a >>> 3),
                        (_a = q[(a + 8) >> 2]),
                        (0 | (lb = q[(a + 12) >> 2])) == (0 | _a) ? ((rb = q[2087] & dd(mb)), (q[8348 >> 2] = rb)) : ((q[(_a + 12) >> 2] = lb), (q[(lb + 8) >> 2] = _a)));
                    else {
                      if (((pb = q[(a + 24) >> 2]), (0 | (_a = q[(a + 12) >> 2])) != (0 | a))) ((lb = q[(a + 8) >> 2]), (q[(lb + 12) >> 2] = _a), (q[(_a + 8) >> 2] = lb));
                      else if ((mb = q[(lb = (a + 20) | 0) >> 2]) || (mb = q[(lb = (a + 16) | 0) >> 2])) {
                        for (;;) if (((ob = lb), !((mb = q[(lb = ((_a = mb) + 20) | 0) >> 2]) || ((lb = (_a + 16) | 0), (mb = q[(_a + 16) >> 2]))))) break;
                        q[ob >> 2] = 0;
                      } else _a = 0;
                      if (pb) {
                        lb = q[(a + 28) >> 2];
                  ...
                  else if (3 == (3 & (_a = q[(4 + nb) >> 2]))) return ((q[2089] = Za), (q[(4 + nb) >> 2] = -2 & _a), (q[(a + 4) >> 2] = 1 | Za), void (q[nb >> 2] = Za));
                }
                f: {
                  if (!(2 & (_a = q[(4 + nb) >> 2]))) {
                    if (q[2093] == (0 | nb)) {
                    ...
                    if (q[2092] == (0 | nb)) return ((q[2092] = a), (Za = (q[2089] + Za) | 0), (q[2089] = Za), (q[(a + 4) >> 2] = 1 | Za), void (q[(a + Za) >> 2] = Za));
                    Za = ((-8 & _a) + Za) | 0;
                    g: if (_a >>> 0 <= 255)
                      ((mb = _a >>> 3),
                        (_a = q[(8 + nb) >> 2]),
                        (0 | (lb = q[(12 + nb) >> 2])) == (0 | _a) ? ((rb = q[2087] & dd(mb)), (q[8348 >> 2] = rb)) : ((q[(_a + 12) >> 2] = lb), (q[(lb + 8) >> 2] = _a)));
                    else {
                ...
                m: {
                  if ((lb = q[2088]) & (ob = 1 << _a)) {
                    for (lb = Za << (31 == (0 | _a) ? 0 : (25 - (_a >>> 1)) | 0), _a = q[mb >> 2]; ;) {
                      ...
                      if (((_a = lb >>> 29), (lb <<= 1), !(_a = q[((ob = (mb + (4 & _a)) | 0) + 16) >> 2]))) break;
                    }
                    q[(ob + 16) >> 2] = a;
                          ...
                          x(
                            x(Za * Za) *
                              x(
                                x(
                                  Za *
                                    x(x(Za * x(x(Za * x(x(Za * x(x(Za * x(0.20697501301765442)) + x(0.23066075146198273))) + x(0.2727281153202057))) + x(0.3333333432674408))) + x(0.4285714328289032))
                      ...
                      (Za = x(
                        a -
                          x(
                            Za *
                              x(
                                x(Za * x(x(Za * x(x(Za * x(x(Za * x(4.138136944220605e-8)) + x(-16533901998627698e-22))) + x(661375597701408e-19))) + x(-0.0027777778450399637))) +
                      ...
                      (a =
                        (0 | (tb = 0 | (j((a = x(x(a - x(Ab - x(Za + x(a * Za)))) + x(1)))), b[0] + (zb << 23)))) <= 8388607
                          ? (function (a, Vk) {
                              ...
                              return x(a * (f(0, (1065353216 + (Vk << 23)) | 0), k()));
                            })(a, zb)
                          : (f(0, tb), k())),
                      (a = x(x(1) * a)));
                  } else a = x(1);
            ...
            function Ca(a) {
              ...
              a: {
                ...
                b: {
                  ...
                  ((a = x(y(a))),
                    Db >>> 0 <= 1066926079
                      ? (Lb = Db >>> 0 <= 1060110335 ? ((a = x(x(x(a + a) + x(-1)) / x(a + x(2)))), 0) : ((a = x(x(a + x(-1)) / x(a + x(1)))), 1))
                      : (Lb = Db >>> 0 <= 1075576831 ? ((a = x(x(a + x(-1.5)) / x(x(a * x(1.5)) + x(1)))), 2) : ((a = x(x(-1) / a)), 3)));
                }
                if (
                  ((Db = Lb),
                  (Nb = x(a * a)),
            ...
            function Da(a, Pb) {
              ...
              return (
                ...
                (Qb = 2147483647 & (Tb = b[0])) >>> 0 <= 1305022426
                  ? ((v[Pb >> 3] = (Ub = +a) + -1.5707963109016418 * (Rb = 0.6366197723675814 * Ub + 6755399441055744 - 6755399441055744) + -1.5893254773528196e-8 * Rb),
                    ...
                    : ((Ub = Qb),
                      ...
                      (Qb = (function (a, Il, Jl) {
                        ...
                        if (((L = Nl = (L - 560) | 0), (Rl = ((Ll = Jl) + w((Wl = 0 < (0 | (Jl = (((Jl + -3) | 0) / 24) | 0)) ? Jl : 0), -24)) | 0), 0 <= (0 | (Sl = q[972]))))
                          for (Ll = (Sl + 1) | 0, Jl = Wl; ;)
                            if (((v[(((320 + Nl) | 0) + (Ml << 3)) >> 3] = (0 | Jl) < 0 ? 0 : +q[(3904 + (Jl << 2)) >> 2]), (Jl = (Jl + 1) | 0), (0 | Ll) == (0 | (Ml = (Ml + 1) | 0)))) break;
                        ((Pl = (Rl + -24) | 0), (Ll = 0));
                        for (;;) {
                          for (Kl = Jl = 0; ;) if (((Kl += v[((Jl << 3) + a) >> 3] * v[(((320 + Nl) | 0) + ((Ll - Jl) << 3)) >> 3]), 1 == (0 | (Jl = (Jl + 1) | 0)))) break;
                            ...
                            if (((Kl = v[((Ll << 3) + Nl) >> 3]), !(Ul = ((Jl = 0) | (Ml = Ll)) < 1)))
                              for (;;)
                                if (
                                  ...
                                  break;
                            ((Kl = ja(Kl, Pl)), (Kl += -8 * C(0.125 * Kl)), (Ql = y(Kl) < 2147483648 ? ~~Kl : -2147483648), (Kl -= 0 | Ql));
                            e: {
                              f: {
                                g: {
                                  if ((Yl = (0 | Pl) < 1)) {
                              ...
                              (Yl || 1 < (Jl = (Pl + -1) | 0) >>> 0 || (q[((Jl = ((Ll << 2) + Nl) | 0) + 476) >> 2] = Jl - 1 ? 8388607 & q[(Jl + 476) >> 2] : 4194303 & q[(Jl + 476) >> 2]),
                                (Ql = (Ql + 1) | 0),
                                2 == (0 | Ol) && ((Kl = 1 - Kl), (Ol = 2), Ml) && (Kl -= ja(1, Pl)));
                            }
                            if (0 != Kl) break;
                            if (!(((Ml = 0) | (Jl = Ll)) <= (0 | Sl))) {
                              for (;;) if (((Ml = q[(((480 + Nl) | 0) + ((Jl = (Jl + -1) | 0) << 2)) >> 2] | Ml), !((0 | Sl) < (0 | Jl)))) break;
                              if (Ml) {
                                for (Rl = Pl; ;) if (((Rl = (Rl + -24) | 0), q[(((480 + Nl) | 0) + ((Ll = (Ll + -1) | 0) << 2)) >> 2])) break;
                                break a;
                              }
                            }
                            for (Jl = 1; ;) if (((Jl = ((Ml = Jl) + 1) | 0), q[(((480 + Nl) | 0) + ((Sl - Ml) << 2)) >> 2])) break;
                            for (Ml = (Ll + Ml) | 0; ;) {
                              for (Ll = Ql = (Ll + 1) | 0, v[(((320 + Nl) | 0) + (Ql << 3)) >> 3] = q[(3904 + ((Wl + Ll) << 2)) >> 2], Kl = Jl = 0; ;)
                                if (((Kl += v[((Jl << 3) + a) >> 3] * v[(((320 + Nl) | 0) + ((Ql - Jl) << 3)) >> 3]), 1 == (0 | (Jl = (Jl + 1) | 0)))) break;
                        ...
                        if (!((0 | Ll) <= -1)) {
                          for (Jl = Ll; ;)
                            if (((v[((Jl << 3) + Nl) >> 3] = Kl * +q[(((480 + Nl) | 0) + (Jl << 2)) >> 2]), (Kl *= 5.960464477539063e-8), (a = 0 < (0 | Jl)), (Jl = (Jl + -1) | 0), !a)) break;
                          if (!((0 | Ll) <= -1))
                            for (Jl = Ll; ;) {
                              for (Pl = (Ll - (a = Jl)) | 0, Jl = Kl = 0; ;)
                                if (((Kl += v[(6672 + (Jl << 3)) >> 3] * v[(((a + Jl) << 3) + Nl) >> 3]), (0 | Sl) <= (0 | Jl) || ((Rl = Jl >>> 0 < Pl >>> 0), (Jl = (Jl + 1) | 0), !Rl))) break;
                              if (((v[(((160 + Nl) | 0) + (Pl << 3)) >> 3] = Kl), (Jl = (a + -1) | 0), !(0 < (0 | a)))) break;
                            }
                        }
                        if (0 <= (Ll | (Kl = 0))) for (;;) if (((Kl += v[(((160 + Nl) | 0) + (Ll << 3)) >> 3]), (a = 0 < (0 | Ll)), (Ll = (Ll + -1) | 0), !a)) break;
            ...
            function Fa(a, Pb, Wb) {
              ...
              if (((q[Pb >> 2] = 652), (Yb = q[(a + 704) >> 2]), 1 <= (0 | (_b = q[Yb >> 2])))) {
                for ($b = q[(a + 720) >> 2], bc = q[(a + 1072) >> 2]; ;) if (((Zb = ((1 << q[(bc + (q[($b + (Xb << 2)) >> 2] << 2)) >> 2]) + Zb) | 0), (0 | _b) == (0 | (Xb = (Xb + 1) | 0)))) break;
                Xb = Zb << 2;
              }
              if (
                ((q[(Pb + 4) >> 2] = w(_b, 12)),
              ...
              if (
                ...
                for ($b = q[(a + 812) >> 2], bc = q[(a + 1072) >> 2], Zb = 0; ;)
                  if (((Zb = ((1 << q[(bc + (q[($b + (Xb << 2)) >> 2] << 2)) >> 2]) + Zb) | 0), (0 | _b) == (0 | (Xb = (Xb + 1) | 0)))) break;
                Xb = Zb << 2;
              }
              if (
                ((q[(Pb + 168) >> 2] = w(_b, 12)),
              ...
              if (
                ...
                for (Zb = q[(a + 1072) >> 2], ac = 0; ;) if (((ac = ((bc = q[(Zb + (Xb << 2)) >> 2]) + ac) | 0), (_b = ((1 << bc) + _b) | 0), (0 | Yb) == (0 | (Xb = (Xb + 1) | 0)))) break;
                ((Xb = _b << 2), (_b = ac << 2));
              }
              if (
                ((q[(Pb + 460) >> 2] = Xb),
              ...
              if (((Yb = q[($b + 76) >> 2]), (q[(Pb + 516) >> 2] = Xb), (q[(Pb + 512) >> 2] = ac), (q[(Pb + 508) >> 2] = Xb), (q[(Pb + 504) >> 2] = Yb << 4), 1 <= (0 | (Yb = q[($b + 80) >> 2])))) {
                for (Zb = q[(a + 1248) >> 2], ac = q[(a + 1072) >> 2], _b = Xb = 0; ;)
                  if (((_b = ((1 << q[(ac + (q[(Zb + (Xb << 2)) >> 2] << 2)) >> 2]) + _b) | 0), (0 | Yb) == (0 | (Xb = (Xb + 1) | 0)))) break;
                Zb = _b << 2;
              }
              if (
                ((q[(Pb + 520) >> 2] = w(Yb, 24)),
                ...
                if (((q[(Pb + 464) >> 2] = w(q[($b + 120) >> 2], 20)), (q[(Pb + 468) >> 2] = w(q[($b + 100) >> 2], 28)), (Zb = Pb), 1 <= ((Xb = ac = 0) | (bc = q[($b + 104) >> 2])))) {
                  for (a = q[(a + 1104) >> 2], _b = 0; ;) if (((_b = (q[(a + (Xb << 2)) >> 2] + _b) | 0), (0 | bc) == (0 | (Xb = (Xb + 1) | 0)))) break;
                  a = _b << 2;
                } else a = 0;
                ((q[(Zb + 476) >> 2] = a),
                  (q[(Pb + 472) >> 2] = w(bc, 48)),
                ...
                if ((0 | (ac = q[($b + 20) >> 2])) < 1) _b = 0;
                  ...
                  for (bc = q[(a + 1060) >> 2], dc = q[(a + 952) >> 2], a = q[(a + 948) >> 2], Zb = _b = 0; ;) {
                    if (1 <= (0 | (cc = q[((Xb = Zb << 2) + dc) >> 2])))
                      for (cc = ((Xb = (bc + (q[(a + Xb) >> 2] << 2)) | 0) + (cc << 2)) | 0; ;) if (((_b = (q[Xb >> 2] + _b) | 0), !((Xb = (Xb + 4) | 0) >>> 0 < cc >>> 0))) break;
              ...
              for (
                ...
                if (((Xb = ((((Yb = q[(a = ((_b << 2) + Pb) | 0) >> 2]) + 15) & -16) + (q[a >> 2] = Xb)) | 0), 140 == (0 | (_b = (_b + 1) | 0)))) break;
              q[Wb >> 2] = Xb;
            }
              ...
              a: {
                if (!(20 < Pb >>> 0 || 9 < (Pb = (Pb + -9) | 0) >>> 0)) {
                  c: switch ((Pb - 1) | 0) {
                    ...
                    case 0:
                      return ((Pb = q[Wb >> 2]), (q[Wb >> 2] = Pb + 4), (Pb = q[Pb >> 2]), (q[a >> 2] = Pb), void (q[(a + 4) >> 2] = Pb >> 31));
                    case 1:
                      return ((Pb = q[Wb >> 2]), (q[Wb >> 2] = Pb + 4), (q[a >> 2] = q[Pb >> 2]), void (q[(a + 4) >> 2] = 0));
                    case 3:
                      return ((Pb = q[Wb >> 2]), (q[Wb >> 2] = Pb + 4), (Pb = p[Pb >> 1]), (q[a >> 2] = Pb), void (q[(a + 4) >> 2] = Pb >> 31));
                    case 4:
                      return ((Pb = q[Wb >> 2]), (q[Wb >> 2] = Pb + 4), (q[a >> 2] = s[Pb >> 1]), void (q[(a + 4) >> 2] = 0));
                    case 5:
                      return ((Pb = q[Wb >> 2]), (q[Wb >> 2] = Pb + 4), (Pb = o[0 | Pb]), (q[a >> 2] = Pb), void (q[(a + 4) >> 2] = Pb >> 31));
                    case 6:
                      return ((Pb = q[Wb >> 2]), (q[Wb >> 2] = Pb + 4), (q[a >> 2] = r[0 | Pb]), void (q[(a + 4) >> 2] = 0));
                    case 2:
                    case 7:
                      break a;
                    case 8:
            ...
            function Ha(a) {
              var Pb,
                hc,
                Wb = 0;
              if (ha(o[q[a >> 2]])) for (;;) if (((Pb = q[a >> 2]), (hc = o[0 | Pb]), (q[a >> 2] = Pb + 1), (Wb = (((w(Wb, 10) + hc) | 0) - 48) | 0), !ha(o[(Pb + 1) | 0]))) break;
              return Wb;
            }
              ...
              a: if (!((0 | vc) < 2))
                for (wc = q[(Bc = ((vc << 2) + a) | 0) >> 2] = yc; ;) {
                  for ($(wc, q[a >> 2], (zc = xc >>> 0 < 256 ? xc : 256)), wc = 0; ;)
                    if (($(q[(Ac = ((wc << 2) + a) | 0) >> 2], q[(((wc = (wc + 1) | 0) << 2) + a) >> 2], zc), (q[Ac >> 2] = q[Ac >> 2] + zc), (0 | vc) == (0 | wc))) break;
                ...
                (((0 | (um = xm >>> 0 < 0 ? (um + 1) | 0 : um)) == (0 | vm)) & (zm >>> 0 < xm >>> 0)) | (vm >>> 0 < um >>> 0)
                  ? ((um = (tm << 4) | (Jl >>> 28)),
                    ...
                    ((134217728 == (0 | (xm = Il &= 268435455))) & (1 <= a >>> 0)) | (134217728 < Il >>> 0)
                      ...
                      : ((um = (um - ((((vm = Jl) >>> 0 < 0) + -1073741824) | 0)) | 0), a | (134217728 ^ xm) || ((a = (vm + (1 & vm)) | 0) >>> 0 < vm >>> 0 && (um = (um + 1) | 0), (vm = a))))
                  : (!xm & (2147418112 == (0 | ym)) ? !(a | Il) : ((2147418112 == (0 | ym)) & (xm >>> 0 < 0)) | (ym >>> 0 < 2147418112))
                    ? ((um = 2146435072),
                      ((1140785151 == ((vm = 0) | ym)) & (4294967295 < xm >>> 0)) | (1140785151 < ym >>> 0) ||
                        ...
                        ((function (a, Il, Jl, tm, Bm, Cm) {
                          ...
                          a: if (64 & Cm)
                            ((Il = 31 & (Jl = (Cm + -64) | 0)),
                              (Il = 32 <= (63 & Jl) >>> 0 ? ((Jl = 0), Bm >>> Il) : ((Jl = Bm >>> Il), ((((1 << Il) - 1) & Bm) << (32 - Il)) | (tm >>> Il))),
                              (Bm = tm = 0));
                          else {
                            if (!Cm) break a;
                            ((Im = Bm),
                              (Jm = tm),
                              (Hm = 31 & (Km = (64 - Cm) | 0)),
                              (Km = 32 <= (63 & Km) >>> 0 ? ((Im = Jm << Hm), 0) : ((Im = (((1 << Hm) - 1) & (Jm >>> (32 - Hm))) | (Im << Hm)), Jm << Hm)),
                              (Jm = Il),
                              (Il = 31 & (Hm = Cm)),
                              ...
                              (Hm = tm),
                              (tm = 31 & Cm),
                              (tm = 32 <= (63 & Cm) >>> 0 ? ((Im = 0), Bm >>> tm) : ((Im = Bm >>> tm), ((((1 << tm) - 1) & Bm) << (32 - tm)) | (Hm >>> tm))),
                              (Bm = Im));
                          }
                          ((q[a >> 2] = Il), (q[(a + 4) >> 2] = Jl), (q[(a + 8) >> 2] = tm), (q[(a + 12) >> 2] = Bm));
                        ...
                        (function (a, Il, Jl, tm, Bm, Cm) {
                          ...
                          64 & Cm
                            ? ((tm = Il),
                              (Il = 31 & (Bm = (Cm + -64) | 0)),
                              32 <= (63 & Bm) >>> 0 ? ((Bm = tm << Il), (tm = 0)) : ((Bm = (((1 << Il) - 1) & (tm >>> (32 - Il))) | (Jl << Il)), (tm <<= Il)),
                              (Jl = Il = 0))
                            : Cm &&
                              ((Dm = tm),
                              (tm = 31 & (Fm = Cm)),
                              (Gm = 32 <= (63 & Cm) >>> 0 ? ((Em = Dm << tm), 0) : ((Em = (((1 << tm) - 1) & (Dm >>> (32 - tm))) | (Bm << tm)), Dm << tm)),
                              (tm = Jl),
                              (Dm = Il),
                              (Bm = 31 & (Cm = (64 - Cm) | 0)),
                              32 <= (63 & Cm) >>> 0 ? ((Cm = 0), (tm >>>= Bm)) : ((Cm = tm >>> Bm), (tm = ((((1 << Bm) - 1) & tm) << (32 - Bm)) | (Dm >>> Bm))),
                              (tm |= Gm),
                              (Bm = Cm | Em),
                              (Cm = Il),
                              (Il = 31 & Fm),
                        ...
                        ((134217728 == (0 | (Jl = a = 268435455 & Jl))) &
                          (1 <= (Il = q[wm >> 2] | ((0 != (q[(16 + wm) >> 2] | q[(24 + wm) >> 2])) | (0 != (q[(20 + wm) >> 2] | q[(28 + wm) >> 2])))) >>> 0)) |
                        (134217728 < a >>> 0)
                ...
                a: {
                  b: {
                    ...
                    if (
                      ...
                      for ((kp = (ap + (gp = -1)) | 0) >>> 0 < 4294967295 && (gp = 0); ;)
                        if (
