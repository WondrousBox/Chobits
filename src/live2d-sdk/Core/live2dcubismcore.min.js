      ...
      (function () {
        function Model(moc) {
          ((this._ptr = _csm.mallocModelAndInitialize(moc._ptr)),
            this._ptr &&
              ((this.parameters = new Parameters(this._ptr)), (this.parts = new Parts(this._ptr)), (this.drawables = new Drawables(this._ptr)), (this.canvasinfo = new CanvasInfo(this._ptr))));
        }
        return (
            ...
            exports: (function (asmLibraryArg, wasmMemory, wasmTable) {
              ...
              return (
                  ...
                  var Dn,
                    ...
                    Bn = (function (a) {
                      ...
                      a: if ((El = 2147483647 & (Gl = b[0])) >>> 0 <= 1061752794) ((Dl = x(1)), El >>> 0 < 964689920 || (Dl = ba(+a)));
                        ...
                        ((Hl = +a),
                          (Dl =
                            1075235812 <= El >>> 0 ? x(-ba(((0 | Gl) < 0 ? 3.141592653589793 : -3.141592653589793) + Hl)) : aa((0 | Gl) <= -1 ? 1.5707963267948966 + Hl : 1.5707963267948966 - Hl)));
                ...
                (n[10] = function (a, Sm, un) {
                  var wn;
                  return (
                    $((wn = q[(20 + (a |= 0)) >> 2]), (Sm |= 0), (Sm = (un |= 0) >>> 0 < (Sm = (q[(a + 16) >> 2] - wn) | 0) >>> 0 ? un : Sm)),
                                ...
                                ((function (a, Il, Jl, tm, Bm, Cm) {
                                  ...
                                  (64 & Cm
                                    ...
                                    : Cm &&
                                      ((Im = Bm),
                                      (Hm = 31 & (Km = (64 - Cm) | 0)),
                                      (Km = 32 <= (63 & Km) >>> 0 ? ((Im = tm << Hm), 0) : ((Im = (((1 << Hm) - 1) & (tm >>> (32 - Hm))) | (Im << Hm)), tm << Hm)),
                                      (Jm = Il),
                                      (Il = 31 & (Hm = Cm)),
                                ...
                                (function (a, Il, Jl, tm, Bm, Cm) {
                                  ...
                                  (64 & Cm
                                    ...
                                    : Cm &&
                                      ((Dm = tm),
                                      (tm = 31 & (Fm = Cm)),
                                      (Dm = 32 <= (63 & Cm) >>> 0 ? ((Em = Dm << tm), 0) : ((Em = (((1 << tm) - 1) & (Dm >>> (32 - tm))) | (Bm << tm)), Dm << tm)),
                                      (tm = Jl),
                                      (Bm = 31 & (Cm = (64 - Cm) | 0)),
                                      32 <= (63 & Cm) >>> 0 ? ((Cm = 0), (tm >>>= Bm)) : ((Cm = tm >>> Bm), (tm = ((((1 << Bm) - 1) & tm) << (32 - Bm)) | (Il >>> Bm))),
                                      (tm |= Dm),
                                      (Bm = Cm | Em),
                                      (Cm = Il),
                                      (Il = 31 & Fm),
                                    ...
                                    if (!(6 <= (Mk = r[(a + 4) | 0]) >>> 0)) {
                                      if (
                                        ...
                                        for (Sk = ((Nk = q[(a + 912) >> 2]) + (Mk << 2)) | 0, Ok = q[(a + 908) >> 2]; ;) {
                                          ...
                                          if (
                                            ((Lk = Nk), 0 < (0 | Mk) && (Mk = q[(Rk + (Kk << 2)) >> 2] < 0 ? Kk : Mk), (q[Lk >> 2] = Mk), (Ok = (Ok + 4) | 0), !((Nk = (Nk + 4) | 0) >>> 0 < Sk >>> 0))
                                          )
                                            break;
                                        }
                                        Lk = q[(a + 704) >> 2];
                                      ...
                                      if (1 <= q[(Lk + 4) >> 2])
                                        for (
                                          Kk = 0;
                                          (q[(q[(a + 744) >> 2] + (Kk << 2)) >> 2] = q[(a + 748) >> 2] + (Kk << 6)), (Lk = q[(a + 704) >> 2]), (0 | (Kk = (Kk + 1) | 0)) < q[(Lk + 4) >> 2];
                                        );
                                      if (1 <= q[(Lk + 16) >> 2])
                                        for (
                                          Kk = 0;
                                      ...
                                      if (1 <= q[(Lk + 20) >> 2])
                                        for (
                                          Kk = 0;
                                          (q[(q[(a + 916) >> 2] + (Kk << 2)) >> 2] = q[(a + 920) >> 2] + (Kk << 6)), (Lk = q[(a + 704) >> 2]), (0 | (Kk = (Kk + 1) | 0)) < q[(Lk + 20) >> 2];
                                        );
                                      if (1 <= q[(Lk + 80) >> 2])
                                        for (
                                          Kk = 0;
                                          (q[(q[(a + 1240) >> 2] + (Kk << 2)) >> 2] = q[(a + 1244) >> 2] + (Kk << 6)), (Lk = q[(a + 704) >> 2]), (0 | (Kk = (Kk + 1) | 0)) < q[(Lk + 80) >> 2];
                                        );
                      ...
                      return (-64 - a) >>> 0 <= Vk >>> 0
                        ...
                        : (ql = qa((12 + (((tl = Vk >>> 0 < 11 ? 16 : (Vk + 11) & -8) + a) | 0)) | 0))
                          ? ((Vk = (ql + -8) | 0),
                            ql & (a + -1)
                              ? ((ul =
                                  ((-8 & (wl = q[(vl = (ql + -4) | 0) >> 2])) - (ql = ((a = 15 < ((ql = (((((a + ql) | 0) - 1) & (0 - a)) - 8) | 0) - Vk) >>> 0 ? ql : (a + ql) | 0) - Vk) | 0)) | 0),
                                3 & wl
                ...
                a: if (a) {
                  ...
                  b: if (!(1 & $)) {
                    ...
                    if (((a = (a + $) | 0), q[2092] != (0 | ba)))
                      if ($ >>> 0 <= 255)
                        ((ca = q[(ba + 8) >> 2]), ($ >>>= 3), (0 | (v = q[(ba + 12) >> 2])) == (0 | ca) ? ((ha = q[2087] & dd($)), (q[2087] = ha)) : ((q[(ca + 12) >> 2] = v), (q[(v + 8) >> 2] = ca)));
                      else {
                  ...
                  if (!(da >>> 0 <= ba >>> 0) && 1 & ($ = q[(4 + da) >> 2])) {
                    f: {
                      if (!(2 & $)) {
                        ...
                        a = ((-8 & $) + a) | 0;
                        g: if ($ >>> 0 <= 255)
                          (($ >>>= 3), (0 | (v = q[(8 + da) >> 2])) == (0 | (ca = q[(12 + da) >> 2])) ? ((ha = q[2087] & dd($)), (q[2087] = ha)) : ((q[(v + 12) >> 2] = ca), (q[(ca + 8) >> 2] = v)));
                        else {
                                      ...
                                      if (a >>> 0 <= 244) {
                                        if (3 & (ia = (ma = q[2087]) >>> (a = (na = a >>> 0 < 11 ? 16 : (a + 11) & -8) >>> 3))) {
                                          ((a = ((ia = q[(8396 + (la = (ja = (a + (1 & (-1 ^ ia))) | 0) << 3)) >> 2]) + 8) | 0),
                                            (0 | (ka = q[(ia + 8) >> 2])) == (0 | (la = (la + 8388) | 0)) ? ((ua = dd(ja) & ma), (q[2087] = ua)) : ((q[(ka + 12) >> 2] = la), (q[(la + 8) >> 2] = ka)),
                                            (q[(ia + 4) >> 2] = 3 | (ja <<= 3)),
                                ...
                                D: {
                                  ...
                                  if (1 == (3 & (ja = q[(ia + 4) >> 2]))) {
                                    ...
                                    G: if (ja >>> 0 <= 255)
                                      ((la = ja >>> 3),
                                        (ja = q[(ia + 8) >> 2]),
                                        (0 | (ka = q[(ia + 12) >> 2])) == (0 | ja) ? ((ua = q[2087] & dd(la)), (q[2087] = ua)) : ((q[(ja + 12) >> 2] = ka), (q[(ka + 8) >> 2] = ja)));
                                    else {
                      ...
                      ((a = 0),
                        (na = ja >>> 8) &&
                          ...
                          16777215 < ja >>> 0 ||
                            (a =
                              (28 +
                                (((a = ((((oa = (na <<= ma = ((na + 1048320) >>> 16) & 8) << (a = ((na + 520192) >>> 16) & 4)) << (na = ((oa + 245760) >>> 16) & 2)) >>> 15) - (na | a | ma)) | 0) <<
                                  1) |
                                  ((ja >>> (a + 21)) & 1))) |
                              0)),
                        (q[((ia = ka) + 28) >> 2] = a),
                  ...
                  (function (a) {
                    ...
                    if (1 <= (0 | (lh = q[(a + 304) >> 2])))
                      for (
                        ...
                        q[jh >> 2] && n[q[(ih + 20) >> 2]](a, kh), (jh = (jh + 4) | 0), (ih = (ih + 32) | 0), (0 | lh) != (0 | (kh = (kh + 1) | 0));
                      );
                  })(a),
                  (function (a) {
                    var Zg,
                      ...
                      if (((fb = ((Wa = q[(Xa + 8) >> 2]) + w($a, 48)) | 0), ($a = q[Xa >> 2] << 2), 1 <= (0 | (db = q[($a + _a) >> 2]))))
                        for (db <<= 1, gb = q[(q[a >> 2] + 1052) >> 2], hb = q[(Za + $a) >> 2]; ;) {
                          b: if (($a = q[(Wa + 8) >> 2])) {
                            ...
                            for (
                              $a = 0;
                              (u[(eb = ((bb = $a << 2) + hb) | 0) >> 2] = u[eb >> 2] + x(u[(Wa + 44) >> 2] * x(u[(bb + ib) >> 2] * u[(Wa + 20) >> 2]))), (0 | db) != (0 | ($a = ($a + 1) | 0));
                            );
                          }
                          if (!((Wa = (Wa + 48) | 0) >>> 0 < fb >>> 0)) break;
                        }
                      else for (; 3 <= ($a = q[(Wa + 8) >> 2]) >>> 0 && ((q[(16 + cb) >> 2] = $a), Y(4, 1024, (16 + cb) | 0)), (Wa = (Wa + 48) | 0) >>> 0 < fb >>> 0;);
                          ...
                          (Wa = (function (a, Il, Jl) {
                            ...
                            if ((ca((16 + (L = cm = (L - 576) | 0)) | 0, 0, 560), Fa(a, (16 + cm) | 0, (12 + cm) | 0), (dm = q[(12 + cm) >> 2]) >>> 0 <= Jl >>> 0)) {
                              ...
                              if (
                                ...
                                for (
                                  bm = (am + q[(468 + cm) >> 2]) | 0, Il = (am + q[(472 + cm) >> 2]) | 0, em = (am + q[(476 + cm) >> 2]) | 0, hm = q[(a + 1072) >> 2], Jl = 0;
                                  (dm = (gm + w(Jl, 36)) | 0),
                                    (q[(dm + 20) >> 2] = em),
                                    (q[(dm + 16) >> 2] = Il),
                                    (q[dm >> 2] = bm),
                              ...
                              if (((Il = q[(a + 704) >> 2]), (dm = (am + q[(516 + cm) >> 2]) | 0), (q[($l + 484) >> 2] = dm), 1 <= (0 | (Il = q[(Il + 72) >> 2]))))
                                for (
                                  ...
                                  (q[(12 + ((dm + w(Jl, 28)) | 0)) >> 2] = bm), (bm = ((q[(em + (Jl << 2)) >> 2] << 4) + bm) | 0), (0 | Il) != (0 | (Jl = (Jl + 1) | 0));
                                );
                                ...
                                if (4 <= (fm = r[(a + 4) | 0]) >>> 0) {
                                  if (
                                    ...
                                    for (
                                      ...
                                      (q[(40 + ((dm + w(Jl, 48)) | 0)) >> 2] = bm), (bm = ((q[(em + (Jl << 2)) >> 2] << 2) + bm) | 0), (0 | Il) != (0 | (Jl = (Jl + 1) | 0));
                                    );
                                ...
                                if (
                                  ...
                                  for (;;)
                                    if (
                                      ...
                                      (pm = q[(dm + hm) >> 2]),
                                      (em = 0),
                                      (em = (q[(Jl + 32) >> 2] = pm) ? (q[($l + 560) >> 2] + w(q[(dm + q[(a + 948) >> 2]) >> 2], 28)) | 0 : em),
                                      (q[(Jl + 48) >> 2] = 1),
                                      (q[(Jl + 28) >> 2] = em),
                                      (q[(dm + om) >> 2] = q[bm >> 2]),
                                      (Jl = 0 < (0 | Il)),
                              ...
                              if (((Il = q[am >> 2]), (0 | (q[($l + 4) >> 2] = Il)) < 1)) Jl = 0;
                                ...
                                for (
                                  fm = q[($l + 16) >> 2], Jl = 0;
                                  (bm = q[(8 + ((gm + w(q[((hm = (Il = (Il + -1) | 0) << 2) + em) >> 2], 36)) | 0)) >> 2]), (Jl = (Jl + (q[(fm + hm) >> 2] = bm)) | 0), 0 < (0 | Il);
                                );
                                Il = q[($l + 4) >> 2];
                              }
                              ...
                              if (((Jl = q[(am + 12) >> 2]), 1 <= (0 | (q[($l + 164) >> 2] = Jl))))
                                for (
                                  em = q[(dm + 828) >> 2], gm = q[(dm + 812) >> 2], fm = q[($l + 568) >> 2], hm = q[($l + 168) >> 2], Il = Jl;
                                  (im = (hm + w((Il = (Il + -1) | 0), 12)) | 0), (q[im >> 2] = fm + w(q[((jm = Il << 2) + gm) >> 2], 36)), (q[(im + 4) >> 2] = q[(em + jm) >> 2]), 0 < (0 | Il);
                                );
                              if (((Il = 0) | bm) < 1) em = 0;
                              else {
                                for (
                                  gm = q[($l + 68) >> 2], fm = q[($l + 60) >> 2], em = 0;
                                  (Jl = q[(q[(fm + w((bm = (bm + -1) | 0), 24)) >> 2] + 8) >> 2]), (em = ((q[(gm + (bm << 2)) >> 2] = Jl) + em) | 0), 0 < (0 | bm);
                                );
                              ...
                              if (((q[($l + 64) >> 2] = bm), (q[($l + 72) >> 2] = em), (bm = $l), 1 <= (0 | Jl))) {
                                for (
                                  ...
                                  (em = q[(q[(fm + w((Jl = (Jl + -1) | 0), 12)) >> 2] + 8) >> 2]), (Il = (Il + (q[(gm + (Jl << 2)) >> 2] = em)) | 0), 0 < (0 | Jl);
                                );
                                Jl = q[($l + 164) >> 2];
                              }
                              if (((q[(bm + 172) >> 2] = Jl), (q[($l + 180) >> 2] = Il), (em = q[(am + 16) >> 2]), 1 <= (0 | (q[($l + 332) >> 2] = em)))) {
                                ...
                                for (
                                  bm = q[($l + 344) >> 2], Jl = 0;
                                  (Il = q[(8 + ((fm + w(q[((hm = (em = (em + -1) | 0) << 2) + gm) >> 2], 36)) | 0)) >> 2]), (Jl = ((q[(bm + hm) >> 2] = Il) + Jl) | 0), 0 < (0 | em);
                                );
                              ...
                              if (((em = q[(am + 72) >> 2]), 1 <= (0 | (q[($l + 480) >> 2] = em))))
                                for (
                                  ...
                                  if (
                                    ...
                                    for (
                                      om = q[(Jl + hm) >> 2], qm = q[(Il + 12) >> 2], pm = q[(dm + 1236) >> 2], sm = q[(dm + 1228) >> 2], rm = q[(dm + 1232) >> 2], Jl = 0;
                              ...
                              if (((Jl = q[(am + 80) >> 2]), (0 | (q[($l + 500) >> 2] = Jl)) < 1)) bm = 0;
                                ...
                                if ((0 | (Jl = q[($l + 500) >> 2])) < 1) bm = 0;
                                  ...
                                  for (
                                    fm = q[($l + 512) >> 2], bm = 0;
                                    (Il = q[(8 + ((gm + w(q[((hm = (Jl = (Jl + -1) | 0) << 2) + em) >> 2], 36)) | 0)) >> 2]), (bm = ((q[(fm + hm) >> 2] = Il) + bm) | 0), 0 < (0 | Jl);
                                  );
                                  Jl = q[($l + 500) >> 2];
                                }
                              }
                              ...
                              o: if (4 <= r[(a + 4) | 0]) {
                                if (!((em = r[(dm + 4) | 0]) >>> 0 < 4)) {
                                  ...
                                  if (((am = q[(dm + 704) >> 2]), (bm = q[(am + 100) >> 2]), 1 <= (0 | (q[($l + 580) >> 2] = bm))))
                                    for (
                                      gm = q[(dm + 1084) >> 2], fm = q[(dm + 1076) >> 2], hm = q[(dm + 1192) >> 2], im = q[(dm + 1080) >> 2], jm = q[($l + 584) >> 2];
                                  ...
                                  if (!(em >>> 0 < 4)) {
                                    if (((em = q[(a + 704) >> 2]), (Jl = q[(em + 108) >> 2]), 1 <= (0 | (q[($l + 604) >> 2] = Jl))))
                                      for (
                                        am = q[(a + 1124) >> 2], gm = q[(a + 1128) >> 2], fm = q[(a + 1120) >> 2], hm = q[($l + 592) >> 2], im = q[($l + 608) >> 2];
                                    ...
                                    if (((Jl = q[(em + 112) >> 2]), 1 <= (0 | (q[($l + 620) >> 2] = Jl))))
                                      for (
                                        em = q[(a + 1148) >> 2], am = q[(a + 1152) >> 2], gm = q[(a + 1144) >> 2], fm = q[($l + 592) >> 2], hm = q[($l + 624) >> 2];
                              ...
                              if (!((r[(a + 4) | 0] < 5) | (r[(q[$l >> 2] + 4) | 0] < 4))) {
                                if (((Il = q[(a + 704) >> 2]), (Jl = q[(Il + 128) >> 2]), 1 <= (0 | (q[($l + 596) >> 2] = Jl))))
                                  for (
                                    em = q[(a + 1112) >> 2], am = q[(a + 1116) >> 2], gm = q[(a + 1108) >> 2], fm = q[($l + 592) >> 2], hm = q[($l + 600) >> 2];
                                ...
                                if (((Jl = q[(Il + 132) >> 2]), 1 <= (0 | (q[($l + 612) >> 2] = Jl))))
                                  for (
                                    em = q[(a + 1136) >> 2], am = q[(a + 1140) >> 2], gm = q[(a + 1132) >> 2], fm = q[($l + 592) >> 2], hm = q[($l + 616) >> 2];
                                    (dm = (hm + w((Jl = (Jl + -1) | 0), 12)) | 0),
                                      (q[dm >> 2] = q[((bm = Jl << 2) + gm) >> 2]),
                                      (q[(dm + 4) >> 2] = q[(am + bm) >> 2]),
                                      (q[(dm + 8) >> 2] = fm + w(q[(bm + em) >> 2], 48)),
                                ...
                                if (((Jl = q[(Il + 136) >> 2]), !((0 | (q[($l + 628) >> 2] = Jl)) < 1)))
                                  for (
                                    dm = q[(a + 1160) >> 2], bm = q[(a + 1164) >> 2], em = q[(a + 1156) >> 2], am = q[($l + 592) >> 2], gm = q[($l + 632) >> 2];
                  ...
                  b: if (!(1 & (_a = q[(a + 4) >> 2]))) {
                    ...
                    if (((Za = ((_a = q[a >> 2]) + Za) | 0), (0 | (a = (a - _a) | 0)) != q[2092]))
                      if (_a >>> 0 <= 255)
                        ((mb = _a >>> 3),
                          (_a = q[(a + 8) >> 2]),
                          (0 | (lb = q[(a + 12) >> 2])) == (0 | _a) ? ((rb = q[2087] & dd(mb)), (q[2087] = rb)) : ((q[(_a + 12) >> 2] = lb), (q[(lb + 8) >> 2] = _a)));
                      else {
                  ...
                  f: {
                    if (!(2 & (_a = q[(4 + nb) >> 2]))) {
                      ...
                      g: if (_a >>> 0 <= 255)
                        ((mb = _a >>> 3),
                          (_a = q[(8 + nb) >> 2]),
                          (0 | (lb = q[(12 + nb) >> 2])) == (0 | _a) ? ((rb = q[2087] & dd(mb)), (q[2087] = rb)) : ((q[(_a + 12) >> 2] = lb), (q[(lb + 8) >> 2] = _a)));
                      else {
                  ...
                  ((q[(a + 16) >> 2] = 0),
                    ...
                    (mb = Za >>> 8) &&
                      ...
                      16777215 < Za >>> 0 ||
                        (_a =
                          (28 +
                            (((_a = ((((nb = (mb <<= ob = ((mb + 1048320) >>> 16) & 8) << (_a = ((mb + 520192) >>> 16) & 4)) << (mb = ((245760 + nb) >>> 16) & 2)) >>> 15) - (mb | _a | ob)) | 0) <<
                              1) |
                              ((Za >>> (_a + 21)) & 1))) |
                          0)),
                              ...
                              x(Za * Za) *
                                x(
                                  x(
                                    Za *
                                      x(
                                        x(Za * x(x(Za * x(x(Za * x(x(Za * x(0.20697501301765442)) + x(0.23066075146198273))) + x(0.2727281153202057))) + x(0.3333333432674408))) + x(0.4285714328289032)
                                      )
                      ...
                      : ((Ub = Qb),
                        ...
                        (Qb = (function (a, Il, Jl) {
                          ...
                          if (((L = Nl = (L - 560) | 0), (Rl = ((Ll = Jl) + w((Wl = 0 < (0 | (Jl = (((Jl + -3) | 0) / 24) | 0)) ? Jl : 0), -24)) | 0), 0 <= (0 | (Sl = q[972]))))
                            for (
                              Ll = (Sl + 1) | 0, Jl = Wl;
                              (v[(((320 + Nl) | 0) + (Ml << 3)) >> 3] = (0 | Jl) < 0 ? 0 : +q[(3904 + (Jl << 2)) >> 2]), (Jl = (Jl + 1) | 0), (0 | Ll) != (0 | (Ml = (Ml + 1) | 0));
                            );
                          for (Pl = (Rl + -24) | 0, Ll = 0; ;) {
                        ...
                        if (a) {
                          ...
                          if (q[q[1789] >> 2]) {
                            ...
                            if (!(57344 != (-8192 & Il) && 55296 <= Il >>> 0))
                              return ((o[(a + 2) | 0] = (63 & Il) | 128), (o[0 | a] = (Il >>> 12) | 224), (o[(a + 1) | 0] = ((Il >>> 6) & 63) | 128), 3);
