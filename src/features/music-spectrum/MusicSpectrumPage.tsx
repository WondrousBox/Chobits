...
const transparentCanvasStyle: CSSProperties = {
  background: 'transparent'
};
...
export function MusicSpectrumPage(): JSX.Element {
  ...
  return (
    <div className="w-screen h-screen overflow-hidden select-none bg-transparent" style={draggableWindowStyle}>
      <canvas ref={canvasRef} className="w-full h-full block bg-transparent" style={transparentCanvasStyle} />
    </div>
  );
}
