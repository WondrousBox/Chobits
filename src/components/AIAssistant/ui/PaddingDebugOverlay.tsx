  ...
  return (
    <div
      style={{
        ...
        left: -padding,
        top: -padding,
        width: ASSISTANT_WIDTH + padding * 2,
        height: ASSISTANT_HEIGHT + padding * 2,
        pointerEvents: 'none',
    ...
    >
      ...
      <div style={{ position: 'absolute', left: 0, top: 0, fontSize: 10, background: 'rgba(0,0,0,0.55)', color: '#0f0', padding: '2px 4px', fontFamily: 'monospace' }}>padding={padding}</div>
    </div>
  );
};
