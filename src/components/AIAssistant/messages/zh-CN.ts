...
const asText = (m: MessageProducer | string, ctx?: MessageContext): string => (typeof m === 'function' ? m(ctx) : m);

const catalog: MessageCatalog = {
  welcome: {
    variants: ['叽~', '叽~很高兴见到你，我在这儿等你吩咐。', '欢迎回来！今天想做点什么？']
  },
  loading: {
    default: '正在检查系统中…'
  },
  configure: {
    default: '叽~没有工作空间，请先创建。'
  },
  click: {
    default: '叽~有什么可以帮助你的吗？ 😊',
    variants: ['我在～需要我做点什么吗？', '收到～告诉我你的想法吧。']
  },
  hold: {
    variants: ['可以把我拖到任何位置。']
  },
  ...
  tip: {
    variants: ['小提示：你可以右键我打开更多功能菜单。', '提示：将我拖动到屏幕边缘，我会自动避让窗口。']
  },
  reminder: {
    variants: ['记得适时休息一下，喝口水～', '久坐伤身哦，起来活动一下吧。']
  },
  system: {
