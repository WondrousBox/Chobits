  ...
  return (
    <div className="h-full w-full flex flex-col bg-background text-foreground">
      ...
      <div className="border-b">
        <DragAbleTitle fixed title={<span />} />
      </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {isPreset && <span className="text-[10px] px-1.5 py-0.5 rounded bg-blue-500/10 text-blue-600 dark:text-blue-400 shrink-0">预设</span>}
                        {/* 校验状态 */}
                        {validationStatus === undefined ? (
                          <span className="text-[10px] text-muted-foreground shrink-0">校验中...</span>
                        ) : validationStatus.ok ? (
                          <span className="text-[10px] px-1.5 py-0.5 rounded bg-green-500/10 text-green-600 dark:text-green-400 shrink-0">通过</span>
                        ) : (
                          <Popover>
                      ...
                      <div className="text-xs text-muted-foreground truncate mt-0.5">{wf.description || '暂无描述'}</div>
                    </div>
