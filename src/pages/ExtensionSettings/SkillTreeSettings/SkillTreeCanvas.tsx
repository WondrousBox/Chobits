...
import type { SpriteAnimation } from '@/features/sprite-assistant';
import { resolveSpriteSrc } from '@/features/sprite-assistant';
        ...
        >
          ...
          >
            ...
            {spriteSrc ? (
              ...
              <div className="flex items-center justify-center" style={{ width: spriteW, height: spriteH }}>
