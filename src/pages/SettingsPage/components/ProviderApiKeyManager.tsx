...
import { TbEdit, TbKey, TbPlus, TbStarFilled, TbTrash } from 'react-icons/tb';
...
export function ProviderApiKeyManager({ providerId, providerLabel, fieldKey, fieldLabel, open, onClose }: ProviderApiKeyManagerProps): JSX.Element {
...
export default ProviderApiKeyManager;
